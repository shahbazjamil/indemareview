...
//        console.log('The meridian is ' + e.time.meridian);
    ...
    $('#updateTime #end_date').attr('readonly',true).datepicker("destroy");
        $("#updateTime #start_date").change(function(){
           $("#updateTime #end_date").val($("#updateTime #start_date").val());
    });
    ...
    function calculateTime() {
        ...
        var url = '{{route('member.all-time-logs.calculate-time')}}';
        ...
        $.easyAjax({
            ...
            success: function (response) {
                $('#updateTime #total_time').html(response.total_hours + "Hrs " + response.total_minutes + "Mins");
