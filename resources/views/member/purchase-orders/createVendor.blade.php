...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('member.invoices.index') }}">{{ __($pageTitle) }}</a></li>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" id="companyClientName">Vendor Name</label>
                                    <div class="row">
                                        <div class="col-md-12" id="client_company_div">
                                            <div class="input-icon">
                                                <input type="text" class="form-control" name="" id="vendor_name"
                                                    value="Vendor Name">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Pay By:</label>
                                    <select class="select2 form-control" id="paymentGateway"
                        ...
                        {{--<a href="javascript:;" data-pk="{{ $product->id }}" class="btn btn-success btn btn-outline
                        btn-xs waves-effect add-product">@lang('app.add') <i class="fa fa-plus"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon"><span
                                                            class="ui-icon ui-icon-arrowthick-2-n-s"></span></div>
...
<script>
    ...
    $('.save-form').click(function(){
        ...
        $.easyAjax({
            url:'{{url('admin/finance/invoices/createvendorinvoice')}}',
