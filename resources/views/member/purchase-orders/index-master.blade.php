...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            <a href="{{ route('member.all-invoices.create', ['type' => 'timelog']) }}" class="btn btn-outline btn-inverse btn-sm">@lang('app.create') @lang('app.timeLog') @lang('app.invoice') <i class="fa fa-plus" aria-hidden="true"></i></a>
...
@push('footer-script')
    ...
    <script>
        ...
        function exportData(){
            ...
            var url = '{{ route('member.all-invoices.export', [':startDate', ':endDate', ':status', ':projectID']) }}';
