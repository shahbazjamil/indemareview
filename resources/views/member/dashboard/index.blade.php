...
<div class="white-box">
                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-xs-12 text-center">
                            ...
                            <span class="widget-title"> @lang('modules.dashboard.totalHoursLogged')</span>
                        </div>
                    </div>
                </div>
            </a>
                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-xs-12 text-center">
                            ...
                            <span class="widget-title"> @lang('modules.dashboard.totalPendingTasks')</span>
                        </div>
                    </div>
                </div>
            </a>
                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-xs-12 text-center">
                            ...
                            <span class="widget-title"> @lang('modules.dashboard.totalCompletedTasks')</span>
                        </div>
                    </div>
                </div>
            </a>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body d-flex-border">
                        <ul class="list-task list-group" data-role="tasklist">
                            <li class="list-group-item clearfix m-0 border-right-0" data-role="task">
                                <h3 class="m-0 pull-left">@lang('app.title')</h3> <span
                                        class="pull-right"><h3 class="m-0">@lang('app.dueDate')</h3></span>
                            </li>
                            @forelse($pendingTasks as $key=>$task)
                                @if((!is_null($task->project_id) && !is_null($task->project) ) || is_null($task->project_id))
                                <li class="list-group-item row border-right-0" data-role="task">
                                    <div class="col-xs-8">
    ...
    <div class="row" >
        ...
        @if(in_array('projects',$modules))
        <div class="col-md-6" id="project-timeline" style="display:none"><!--shahbaz! need to remove-->
            <div class="panel panel-inverse d-none">
                    ...
                    <div class="panel-body">
                        <div class="steamline">
                            @forelse($projectActivities as $activity)
                                <div class="sl-item">
                                    <div class="sl-left"><i class="fa fa-circle"></i>
                                    </div>
                                    <div class="sl-right">
        ...
        <div class="col-md-6" id="notices-timeline" style="display:none"><!--shahbaz! need to remove-->
            <div class="panel panel-inverse">
        ...
        <div class="col-md-6" style="display:none"><!--shahbaz! need to remove-->
            <div class="panel panel-inverse">
