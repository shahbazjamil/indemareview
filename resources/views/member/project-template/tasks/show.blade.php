...
<!--                                <li><a href="{{ route('member.project-template-member.show', $project->id) }}"><span>@lang('modules.projects.members')</span></a></li>-->
                                <li ><a href="{{ route('member.project-template-milestone.show', $project->id) }}"><span>@lang('modules.projects.milestones')</span></a></li>
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('member.project-template-task.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    taskListPanel.on('click', '.show-task-detail', function () {
        var id = $(this).data('task-id');
        var url = "{{route('member.project-template-task.detail', ':id')}}";
        url = url.replace(':id', id);
...
//         taskListPanel.switchClass("col-md-12", "col-md-6", 1000, "easeInOutQuad");
    ...
    function showTable() {
        var url = '{!!  route('member.project-template-task.data', [':templateId']) !!}?_token={{ csrf_token() }}';
