                            ...
                            <div class="row">
                                <div class="col-md-12" id="issues-list-panel">
                                    <div class="white-box p-0">
                                        <h2 class="border-bottom">@lang('app.menu.estimates')</h2>

                                        <div class="row m-b-10">
                                            <div class="col-md-12 border-bottom p-b-10">
                                                <a href="{{ route('member.estimates.create') }}" class="btn btn-outline btn-success btn-sm">+ @lang('modules.estimates.createEstimate')</a>
                                            </div>
                                        </div>
...
<script>
    var table = $('#timelog-table').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{!! route('member.estimates-project.data', $project->id) !!}',
        deferRender: true,
        language: {
