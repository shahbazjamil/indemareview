                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="panel-wrapper collapse in">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 m-b-5 project-stats">
                                                                     @lang('modules.projects.openTasks'):<span>{{ count($openTasks) }}</span>
                                                            </div>
                                                            <div class="col-md-12 m-b-5 project-stats">
                                            ...
                                            <div class="col-md-12">
											<div class="panel panel-inverse">
                                                <h5 class="panel-heading m-t-0">@lang('app.project') @lang('app.details')</h5>
                                                <span class="project-detail-content project-details-member">{!! $project->project_summary !!}</span>
												</div>
                                            </div>
                                        </div>
