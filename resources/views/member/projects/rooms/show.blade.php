...
<script>
    ...
    var table = $('#projectroom-table').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{!! route('member.rooms.data', $project->id) !!}',
        deferRender: true,
        language: {
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('member.rooms.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('body').on('click', '.edit-room', function () {
        ...
        var url = '{{ route('member.rooms.edit', ':id')}}';
        url = url.replace(':id', id);
    ...
    $('body').on('click', '.room-detail', function () {
        var id = $(this).data('room-id');
        var url = '{{ route('member.rooms.detail', ":id")}}';
        url = url.replace(':id', id);
