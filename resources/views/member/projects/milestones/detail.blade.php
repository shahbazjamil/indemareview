                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <p>
                                    ...
                                    <a style="display:none;" href="{{ route('member.all-invoices.convert-milestone', $milestone->id) }}" class="btn btn-xs btn-info btn-rounded m-l-15">@lang('app.create') @lang('app.invoice')</a>
                                    @elseif($milestone->cost > 0 && $milestone->invoice_created == 1)
                                        <a href="{{ route('member.all-invoices.show', $milestone->invoice_id) }}" class="btn btn-xs btn-info btn-rounded m-l-15">@lang('app.view') @lang('app.invoice')</a>
                                    @endif
                                </p>
                            </div>
                        </div>
