                    ...
                    @endsection
                                        ...
                                        <div class="row m-b-10">
                                            <div class="col-md-12 border-bottom p-b-10">
                                                <a href="{{ route('member.products.edit', 0) }}" class="btn btn-success btn-outline">+	 @lang('app.addNew') @lang('app.menu.products')</a>
                                            </div>
                                        </div>

                                        <div class="table-responsive m-t-30 member-products-list">
