            ...
            <div class="panel panel-inverse">
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    ...
                    <div class="panel-body">
                        <form method="POST" enctype="multipart/form-data" action="{!! route('member.storeFile') !!}">
                        <div class="form-body">
                            ...
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    ...
                                    @else
                                        <div class="alert alert-danger">@lang('messages.storageLimitExceed', ['here' => '<a href='.route('member.billing.packages'). '>Here</a>'])</div>
                                    @endif
                                </div>
                            </div>
