...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-sm-12 text-left border-bottom p-t-10 p-b-10">
    ...
    <div class="row dashboard-stats">
        ...
        <div class="row">
            <div class="col-md-12 m-t-25">
                <div class="white-box" style="padding-left: 10px; padding-right: 10px">
                                ...
                                @foreach($folders as $folder)
                                    <tr>
                                        <td><span style="margin-right: 3rem">{{ $counter }}</span> 
                                            ...
                                            @else
                                            <a href="{{ route('member.preview_folder', ['folder_id'=>$folder->id]) }}"><i class="fa fa-folder" aria-hidden="true"></i> {{ $folder->folder_name }}</a>
                                            @endif
                                        ...
                                        <td class=" text-center"><div class="btn-group dropdown m-r-10">
                                                <button aria-expanded="false" data-toggle="dropdown" class="btn btn-default" type="button">Action <span class="caret"></span> </button>
                                                <ul role="menu" class="dropdown-menu pull-right">
                                                    <li><a href="{{ route('member.delete_folder', ['folder_id'=>$folder->id]) }}"><i class="fa fa-times" aria-hidden="true"></i> Delete</a></li>
        ...
        <div class="modal-dialog modal-md" id="modal-data-application">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('member.create_folder') }}">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
    ...
    <script>
        $(function () {
            ...
            $('#change-group').click(function () {
                    $.easyAjax({
                        url: '{{route('member.change_password')}}',
