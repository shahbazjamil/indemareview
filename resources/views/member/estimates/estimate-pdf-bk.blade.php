...
<main>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <th class="qty">Sale Price ({!! htmlentities($estimate->currency->currency_code)  !!})</th>
                <th class="qty">Shipping Price ({!! htmlentities($estimate->currency->currency_code)  !!})</th>
            ...
            <tr style="page-break-inside: avoid;" class="subtotal">
                ...
                <td class="qty">&nbsp;</td>
                <td class="qty">&nbsp;</td>
                <td class="qty">@lang("modules.invoices.subTotal")</td>
            ...
            @if($discount != 0 && $discount != '')
                <tr style="page-break-inside: avoid;" class="discount">
                    ...
                    <td class="qty">&nbsp;</td>
                    <td class="qty">&nbsp;</td>
                    <td class="qty">@lang("modules.invoices.discount")</td>
            ...
            @foreach($taxes as $key=>$tax)
                <tr style="page-break-inside: avoid;" class="tax">
                    ...
                    <td class="qty">&nbsp;</td>
                    <td class="qty">&nbsp;</td>
                    <td class="qty">{{ strtoupper($key) }}</td>
