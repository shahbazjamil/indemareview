...
@section('page-title')
    <div class="row bg-title">
        ...
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div @if($totalRecords == 0) style="display: none;"  @endif class="col-xs-12 ">
            <a href="{{ route('member.leads.archive') }}"  class="btn btn-outline btn-danger btn-sm">@lang('app.menu.viewArchive') <i class="fa fa-trash" aria-hidden="true"></i></a>
...
@section('content')
    ...
    <div @if($totalRecords == 0) style="display: none;"  @endif class="row dashboard-stats">
        <div class="col-md-12 front-dashboard">
            <div class="">
                <div class="col-md-4 text-center">
                    <h4 class="white-box"><span class="text-dark-">{{ $totalLeads }}</span> <span class="font-12 text-muted m-l-5"> @lang('modules.dashboard.totalLeads')</span></h4>
                </div>
                <div class="col-md-4 text-center">
                    <h4 class="white-box"><span class="text-info-">{{ $totalClientConverted }}</span> <span class="font-12 text-muted m-l-5"> @lang('modules.dashboard.totalConvertedClient')</span></h4>
                </div>
                <div class="col-md-4 text-center">
                    <h4 class="white-box"><span class="text-warning-">{{ $pendingLeadFollowUps }}</span> <span class="font-12 text-muted m-l-5"> @lang('modules.dashboard.totalPendingFollowUps')</span></h4>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="white-box">
                ...
                <table @if($totalRecords == 0) style="display: none;"  @endif class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="users-table">
                    <thead>
                    <tr>
                        <th>@lang('app.id')</th>
    ...
    <div @if($totalRecords > 0) style="display: none;"  @endif class="row flex-row flex-wrap nolist-content flex-align-start">
		...
		<div class="col-md-8">
			...
			<a href="{{ route('member.leads.create') }}" class="btn-black">+ @lang('modules.lead.addNewLead')</a>
