    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading p-b-15"> @lang('modules.leaves.assignLeave')</div>
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body p-0 p-t-20">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12" id="single-date">
                                ...
                                <div class="col-md-12" id="multi-date" style="display: none">
