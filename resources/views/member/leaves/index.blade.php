    ...
    <div class="row">
        ...
        <div class="col-md-12 border-bottom">
            <div class="white-box p-0">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center"><span class="donut" data-peity='{ "fill": ["red", "#eeeeee"],    "innerRadius": 40, "radius": 60 }'>{{ count($leaves) }}/{{ $allowedLeaves }}</span><br>
        ...
        <div class="col-md-12 border-bottom">
            <div class="panel panel-default">
                <div class="panel-heading border-0 p-b-0 border-bottom">@lang('modules.leaves.pendingLeaves')</div>
                <div class="panel-wrapper collapse in">
                    <div class="panel-body p-0 p-t-15">
        ...
        <div class="col-md-12">
            <div class="white-box p-0">
                <div class="row">
                    <h3 class="col-md-12 border-bottom p-b-10">@lang('app.menu.leaves')</h3>
