...
<main>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <th class="qty">Sale Price ({!! htmlentities($invoice->currency->currency_code)  !!})</th>
            <th class="qty">Shipping ({!! htmlentities($invoice->currency->currency_code)  !!})</th>
        ...
        @foreach($invoice->items as $item)
            ...
            <tr style="page-break-inside: avoid;">
                ...
                @if($item->picture != '')
                    <td><img src="{{ asset('user-uploads/products/'.$item->product_id.'/'.$item->picture.'') }}" alt="product" width="50" height="50"></td>
                @else
                    <td><img src="{{ asset('img/img-dummy.jpg') }}" alt="product" width="50" height="50"></td>
                @endif
                ...
                <td class="qty"><h3>{{ number_format((float)$item->sale_price, 2, '.', '') }}</h3></td>
                <td class="qty"><h3>{{ number_format((float)$item->shipping_price, 2, '.', '') }}</h3></td>
