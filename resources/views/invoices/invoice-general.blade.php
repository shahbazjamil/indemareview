                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0" style="font-family: 'Lato', sans-serif;font-size:12px;width:100%;table-layout:fixed;padding:0">
                                                                                <tr>
                                                                                        <td style="width:25%">
                                                                                            ...
                                                                                            ?>
                                                                                            <img src="{{ $picture }}" width="50" style="margin-right:20px" alt="{{$item->item_name}}"/>
                                                                                             @elseif($item->invoice_item_type == 'product')
                                                                                                @if($item->product_url == 'https://app.indema.co/img/img-dummy.jpg')
                                                                                                &nbsp;
<!--                                                                                                    <img src="{{ asset('img/default-product.png') }}" width="50" style="margin-right:20px" alt="{{$item->item_name}}"/>-->
                                                                                                @else
