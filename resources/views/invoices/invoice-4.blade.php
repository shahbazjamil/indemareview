                ...
                @foreach($invoice->items as $item)
                    @if($item->type == 'item')
                        <tr data-iterate="item">
                            ...
                            @if($item->picture != '')
                                <td><img src="{{ asset('user-uploads/products/'.$item->product_id.'/'.$item->picture.'') }}" alt="product" width="75" height="75"></td>
                            @else
                                <td><img src="{{ asset('img/img-dummy.jpg') }}" alt="product" width="75" height="75"></td>
                            @endif
