...
<script>
    ...
    if(currentUrl == 'member.projects.free-flow-gantt' || currentUrl == 'member.client-invoice.index' || currentUrl == 'member.products.index' || currentUrl == 'member.clients.index' || currentUrl == 'member.leads.index' || currentUrl == 'member.vendor.index' || currentUrl == 'member.employees.index' || currentUrl == 'member.contracts.index' 
            || currentUrl == 'member.projects.index' || currentUrl == 'member.all-tasks.index' || currentUrl == 'member.all-time-logs.index' || currentUrl == 'member.estimates.index' || currentUrl == 'member.payments.index' || currentUrl == 'member.expenses.index' ||  currentUrl == 'member.all-credit-notes.index' 
            || currentUrl == 'member.task-report.index' || currentUrl == 'member.time-log-report.index' || currentUrl == 'member.finance-report.index' || currentUrl == 'member.income-expense-report.index' || currentUrl == 'member.leave-report.index' || currentUrl == 'member.attendance-report.index' 
            || currentUrl == 'member.reports.index' || currentUrl == 'member.products-project.show') {
