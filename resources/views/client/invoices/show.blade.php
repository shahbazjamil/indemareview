...
<!--                                                         <td class="text-center"><img src="{{ asset('img/default-product.png') }}" width="75" height="75" alt="{{$item->item_name}}"/></td>-->
                                                    @else
                                                         <td class="text-center"><img src="{{ $item->product_url }}" width="75" height="75" alt="{{$item->item_name}}"/></td>
                                                    @endif
