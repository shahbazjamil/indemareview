...
<!--            <a href="{{ route('client.projects.edit', $project->id) }}" class="btn btn-sm btn-info btn-outline" ><i class="icon-note"></i> @lang('app.edit')</a>-->
            <ol class="breadcrumb">
                        ...
                        <section class="show" id="discussion">
                            <div class="white-box p-0">
                                ...
                                <div class="row m-b-10">
                                    <div class="col-xs-12 border-bottom p-b-10">
                                        <a href="{{ route('client.projects.discussion', $project->id) }}" class="btn btn-default"><i class="fa fa-chevron-left"></i> @lang('app.back')</a>
...
<!--                                                        <a href="javascript:;"
                                                        data-reply-id="" class="m-l-10 font-12 edit-reply text-muted">
...
<script>
    ...
    $('body').on('click', '.delete-reply', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('client.discussion-reply.destroy',':id') }}";
    ...
    $('body').on('click', '.add-reply', function () {
        var url = '{{ route('client.discussion-reply.create', ['id' => $discussion->id]) }}';
    ...
    $('body').on('click', '.edit-reply', function () {
        ...
        var url = '{{ route('client.discussion-reply.edit', ':id') }}';
    ...
    $('body').on('click', '.set-best-answer', function () {
        ...
        var url = '{{ route('client.discussion.setBestAnswer') }}';
        var token = "{{ csrf_token() }}";
