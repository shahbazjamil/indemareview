    ...
    $('#save-task').click(function () {
        $.easyAjax({
            ...
            success: function (data) {
                $("#user_id").select2("val", "");
                $('#milestone_id').prop('selectedIndex',0).change();
...
//         taskListPanel.switchClass("col-md-12", "col-md-6", 1000, "easeInOutQuad");
    ...
    function showTable() {
        ...
        table.sortable({ items: "tr", cursor: "move", opacity: 0.6, update: function() { updatePageOrder(); }});
    }
     ...
     function updatePageOrder() {
            ...
            var url = '{{ route('admin.project-template-task.upadte-order') }}';
            var token = "{{ csrf_token() }}";
            $.easyAjax({
                type: 'POST',
                url: url,
