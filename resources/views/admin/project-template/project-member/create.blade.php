            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box p-0">
                        <nav>
                            <ul>
                                <li><a href="{{ route('admin.project-template.show', $project->id) }}" class="btn-default"><span>@lang('modules.projectTemplate.overview')</span></a>
                                </li>
                                <li class="tab-current"><a href="{{ route('admin.project-template-member.show', $project->id) }}" class="btn-default"><span>@lang('modules.projectTemplate.members')</span></a></li>

                                <li><a href="{{ route('admin.project-template-task.show', $project->id) }}" class="btn-default"><span>@lang('app.menu.tasks')</span></a></li>
                            </ul>
                        </nav>
                    </div>
