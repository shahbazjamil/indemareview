...
<!--                                <li><a href="{{ route('admin.project-template-member.show', $project->id) }}"><span>@lang('modules.projects.members')</span></a></li>-->
                                <li class="tab-current"><a href="{{ route('admin.project-template-milestone.show', $project->id) }}"><span>@lang('modules.projects.milestones')</span></a></li>
...
//         taskListPanel.switchClass("col-md-12", "col-md-6", 1000, "easeInOutQuad");
    ...
    function showTable() {
        var url = '{!!  route('admin.project-template-milestone.data', [':templateId']) !!}?_token={{ csrf_token() }}';
