        ...
        <div class="col-sm-12 border-bottom p-t-10 p-b-10">
            <div class="form-group">
                <a href="{{ route('admin.attendances.create') }}"
                   class="btn btn-success btn-sm">+ @lang('modules.attendance.markAttendance') </a>
            </div>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
    ...
    <div class="row">
        ...
        <div class="sttabs tabs-style-line col-md-12">
            <div class="white-box p-0">
                <nav>
                    <ul>
                        <li><a href="{{ route('admin.attendances.summary') }}" class="btn-default"><span>@lang('app.summary')</span></a>

                        <li class="tab-current"><a href="{{ route('admin.attendances.index') }}" class="btn-default"><span>@lang('modules.attendance.attendanceByMember')</span></a>
                        </li>
                        <li><a href="{{ route('admin.attendances.attendanceByDate') }}" class="btn-default"><span>@lang('modules.attendance.attendanceByDate')</span></a>
                        </li>
                ...
                <div class="col-md-12 m-b-30">
                    <div class="white-box p-0">
                        <div class="col-md-2  col-sm-4 text-center">
                            <h4 class="white-box"><span class="text-dark-" id="totalWorkingDays">{{ $totalWorkingDays }}</span> <span class="font-12 text-muted m-l-5"> @lang('modules.attendance.totalWorkingDays')</span></h4>
                        </div>
                        <div class="col-md-2 b-l  col-sm-4 text-center">
                            <h4 class="white-box"><span class="text-success-" id="daysPresent">{{ $daysPresent }}</span> <span class="font-12 text-muted m-l-5"> @lang('modules.attendance.daysPresent')</span></h4>
                        </div>
                        <div class="col-md-2 b-l  col-sm-4 text-center">
                            <h4 class="white-box"><span class="text-danger-" id="daysLate">{{ $daysLate }}</span> <span class="font-12 text-muted m-l-5"> @lang('app.days') @lang('modules.attendance.late')</span></h4>
                        </div>
                        <div class="col-md-2 b-l  col-sm-4 text-center">
                            <h4 class="white-box"><span class="text-warning-" id="halfDays">{{ $halfDays }}</span> <span class="font-12 text-muted m-l-5"> @lang('modules.attendance.halfDay')</span></h4>
                        </div>
                        <div class="col-md-2 b-l  col-sm-4 text-center">
                            <h4 class="white-box"><span class="text-info-" id="absentDays">{{ (($totalWorkingDays - $daysPresent) < 0) ? '0' : ($totalWorkingDays - $daysPresent) }}</span> <span class="font-12 text-muted m-l-5"> @lang('app.days') @lang('modules.attendance.absent')</span></h4>
                        </div>
                        <div class="col-md-2 b-l  col-sm-4 text-center">
                            <h4 class="white-box"><span class="text-primary-" id="holidayDays">{{ $holidays }}</span> <span class="font-12 text-muted m-l-5"> @lang('modules.attendance.holidays')</span></h4>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function showTable() {
        ...
        var startDate_new = startDate.replace('/', '-').replace('/', '-');
        var endDate = $('#end-date').val();
        var endDate_new = endDate.replace('/', '-').replace('/', '-');
        ...
        url = url.replace(':startDate', startDate_new);
        url = url.replace(':endDate', endDate_new);
        ...
        url2 = url2.replace(':startDate', startDate_new);
        url2 = url2.replace(':endDate', endDate_new);
        url2 = url2.replace(':userId', userId);
        
        url2 = url2 + '?startDate='+startDate+'&endDate='+endDate; 
