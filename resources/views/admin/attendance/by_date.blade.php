...
@section('page-title')
    <div class="row bg-title">
        ...
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="border-bottom p-t-10 p-b-10 col-xs-12">
            <a href="{{ route('admin.attendances.create') }}"
            class="btn btn-success btn-sm btn-outline">+ @lang('modules.attendance.markAttendance') </a>
            <ol class="breadcrumb">
            ...
            <div class="white-box p-0">
                <nav>
                    <ul>
                        ...
                        <li><a href="{{ route('admin.attendances.index') }}" class="btn-default"><span>@lang('modules.attendance.attendanceByMember')</span></a>
                        </li>
                        <li class="tab-current"><a href="{{ route('admin.attendances.attendanceByDate') }}" class="btn-default"><span>@lang('modules.attendance.attendanceByDate')</span></a>
                        </li>
                    ...
                    <div class="col-md-12 m-b-30">
                        <div class="white-box p-0">
                            <div class="col-sm-4 text-center">
                                <h4 class="white-box"><span class="text-info-" id="totalEmployees">0</span> <span class="font-12 text-muted m-l-5"> @lang('modules.dashboard.totalEmployees')</span></h4>
                            </div>
                            <div class="col-sm-4 text-center">
                                <h4 class="white-box"><span class="text-success-" id="employeesPresent">0</span> <span class="font-12 text-muted m-l-5"> @lang('modules.attendance.present')</span></h4>
                            </div>
                            <div class="col-sm-4 text-center">
                                <h4 class="white-box"><span class="text-danger-" id="employeesAbsent">0</span> <span class="font-12 text-muted m-l-5"> @lang('app.days') @lang('modules.attendance.absent')</span></h4>
                            </div>
