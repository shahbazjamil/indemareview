...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="border-bottom col-xs-12 p-t-10 p-b-10">
            ...
            class="btn btn-success btn-outline btn-sm">+ @lang('modules.attendance.markAttendance') </a>
            <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="sttabs tabs-style-line col-md-12">
            <div class="white-box p-0">
                <nav>
                    <ul>
                        <li class="tab-current"><a href="{{ route('admin.attendances.summary') }}" class="btn-default"><span>@lang('app.summary')</span></a>
                        </li>
