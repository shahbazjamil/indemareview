        ...
        <div class="white-box p-0">
            <div class="sttabs tabs-style-line">
                ...
                <div class="border-bottom col-xs-12 p-t-10 p-b-10">
                    <a href="javascript:;" id="add-column" class="btn btn-success btn-outline btn-sm">+ @lang('modules.tasks.addBoardColumn')</a>
                </div>
            ...
            <input type="hidden" name="project_idd" value="{{ $project->id }}" /> 
...
<script>
    ...
    $('ul.showProjectTabs .projectTasksBoard').addClass('tab-current');
