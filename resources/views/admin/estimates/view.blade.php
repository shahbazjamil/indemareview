    ...
    <div id="page-wrapper" style="margin-left: 0px !important;">
        <div class="container-fluid">
            ...
            <div class="row" style="margin-top: 70px; !important;">
                ...
                <div class="col-md-offset-2 col-md-8 col-md-offset-2 sb-1" id="estimates">
                                            ...
                                            <div class="table-responsive m-t-40" style="clear: both;">
                                                <table class="table table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-center" style="padding: 8px 15px">Type</th>
                                                        <th class="text-center" style="padding: 8px 15px">Group</th>
                                                        <th class="text-right">@lang("modules.invoices.qty")</th>
                                                        <th class="text-right" style="padding: 8px 15px">@lang('modules.invoices.unitPrice')</th>
                                                        <th class="text-right">Markup %</th>
                                                        <th class="text-right">Markup {{ $global->currency->currency_symbol }}</th>
                                                    ...
                                                    @foreach($estimate->items as $item)
                                                        @if($item->type == 'item')
                                                            <tr>
                                                                ...
                                                                @if($item->picture != '')
                                                                    <td class="text-center"><img src="{{ asset('user-uploads/products/'.$item->product_id.'/'.$item->picture.'') }}" alt="product" width="75" height="75"></td>
                                                                @elseif($item->invoice_item_type == 'product')
                                                                    @if($item->product_url == 'https://app.indema.co/img/img-dummy.jpg')
                                                                        <td class="text-center"><img src="{{ asset('img/default-product.png') }}" alt="product" width="75" height="75"></td>
                                                                    @else
                                                                ...
                                                                <td class="text-right">{{ ucfirst($item->invoice_item_type) }}</td>
                                                                
                                                                @if(isset($item->group_id) && isset($item->group))
                                                                    <td class="text-right">{{ ucfirst($item->group->group_name) }}</td>
                                                                @else
                                                                    <td class="text-right">&nbsp;</td>
                                                                @endif
                                                                
                                                                <td class="text-right">{{ $item->quantity }}</td>
                                                                <td class="text-right">{!! currency_position($item->unit_price, $estimate->currency->currency_symbol) !!}</td>
                                                                <td class="text-right">{{ $item->markup }}</td>
                                                                <td class="text-right">{!! currency_position($item->markup_fix, $estimate->currency->currency_symbol) !!}</td>
                                                                <td class="text-right"> {!! htmlentities($estimate->currency->currency_symbol)  !!}{{$item->sale_price}} </td>
                                                                <td class="text-right"> {!! htmlentities($estimate->currency->currency_symbol)  !!}{{$item->shipping_price}} </td>
