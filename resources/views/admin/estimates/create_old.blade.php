    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading p-b-10 m-b-20"> @lang('modules.estimates.createEstimate')</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text"  class="form-control readonly-background" name="estimate_number" id="estimate_number" value="@if(is_null($lastEstimate))1 @else{{ ($lastEstimate) }}@endif">
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <select name="project_id" id="project_id" class="select2 form-control" data-placeholder="Choose Project">
                                            ...
                                            <div class="col-md-12">
                                                <select class="select2 form-control" data-placeholder="Choose Client" name="client_id" id="client_company_id">
                                                    ...
                                                    @foreach($clients as $client)
                                                        <option data-shippingadd="{!! $client->shipping_address !!}" value="{{ $client->user_id }}">{{ ucwords(!is_null($client->company_name) ? $client->name . ' (' . $client->company_name .')' : $client->name) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 border-bottom">
                                    <div class="btn-group m-b-10">
                                        <button aria-expanded="false" data-toggle="dropdown" class="btn btn-info dropdown-toggle waves-effect waves-light" type="button" onclick="$('#produbctsModal').show();">+ @lang('app.menu.addProducts')</button>
                                                ...
                                                <div class="col-xs-12 item-row margin-top-5 d-flex-border">
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="form-group">
                                                            ...
                                                            <p class="form-control-static"><img src="{{ $fileUrl }}" alt="product" width="100" height="100"></p>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p class="form-control-static">
                                                        <label>
                                                            ...
                                                            <img src="{{ asset('img/img-dummy.jpg') }}" alt="product" width="100" height="100">
                                                        </label>
                                                    </p>
                                ...
                                <div class="col-xs-12 border-bottom">
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-9 col-md-1 text-right p-t-5">
                                            Tax <a href="javascript:;" id="tax-settings"><i
    ...
    <script>
        ...
        $('#add-item').click(function () {
            ...
            var item = '<div class="col-xs-12 item-row margin-top-5 d-flex-border">'
                ...
                + '<label class="control-label hidden-md hidden-lg">@lang('app.product.tabs.picture')</label>'
                + '<p class="form-control-static">'
                + ' <label> <input type="file" class="product_img" style="display: none" name="product_img[]">'
                + '<img src="{{ asset('img/img-dummy.jpg') }}" alt="product" width="100" height="100"> </label></p>'
                + '<input type="hidden" class="form-control" value="" name="product_id[]" >'
                + '<input type="hidden" class="form-control" value="" name="picture[]" >'
                + '</div>'
                + '</div>'
        ...
        $('#storePayments').on('keyup change','.markup, .cost_per_item', function () {
            var quantity = 0;
        ...
        $('#storePayments').on('keyup change','.markup_fix, .cost_per_item', function () {
            var quantity = 0;
            if($(this).closest('.item-row').find('.quantity').val()) {
                quantity = $(this).closest('.item-row').find('.quantity').val();
            }
