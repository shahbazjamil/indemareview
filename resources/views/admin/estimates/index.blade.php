...
@section('page-title')
    <div class="row bg-title">
        ...
        <div @if($totalRecords == 0) style="display: none;"  @endif class="border-bottom col-xs-12 p-t-10 p-b-10">
            <a href="{{ route('admin.estimates.create') }}" class="btn btn-outline btn-success btn-sm">+ @lang('modules.estimates.createEstimate')</a>
...
@section('content')
    ...
    <div @if($totalRecords > 0) style="display: none;"  @endif class="row flex-row flex-wrap nolist-content flex-align-start">
		<div class="col-md-4"><img src="{{ asset('img/create-estimate.jpg') }}" class="img-responsive" alt="" /></div>
		<div class="col-md-8">
			<h1 class="page-title m-b-30">Create E-signable Estimates!</h1>
			<p class="m-b-30">Create estimates for your clients to approve or decline sourced products. Send to your client so they can approve and  e-sign the estimate. Estimates also auto-convert to invoices and purchase orders!</p>
			<a href="{{ route('admin.estimates.create') }}" class="btn-black">+ @lang('modules.estimates.createEstimate')</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
				<div class="modal-header p-t-15 p-b-15 p-r-15">
					<h4 class="modal-title">Create E-signable Estimates!</h4>
...
<script>
    ...
    $('body').on('click', '.sendButton', function(){
     ...
     $('#video-modal').on('show.bs.modal', function (e) {
      ...
      $('#video-modal .modal-body').html('<div class="embed-responsive embed-responsive-16by9"><iframe width="560" height="315" src="https://www.youtube.com/embed/FOVNqjunlGY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;" allowfullscreen></iframe></div>');
    });
    //on close remove
