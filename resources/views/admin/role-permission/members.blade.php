            ...
            <table class="table">
                ...
                @forelse($role->roleuser as $key=>$ruser)
                    <tr id="ruser-{{ $ruser->user->id }}">
                        ...
                        <td>
                            @if($ruser->user->email == $company->company_email)
                            --
                            @else 
                            <a href="javascript:;" data-ruser-id="{{ $ruser->user->id }}" class="btn btn-sm btn-danger btn-rounded delete-category">@lang("app.remove")</a>
                            @endif
                        </td>
                    </tr>
                @empty
