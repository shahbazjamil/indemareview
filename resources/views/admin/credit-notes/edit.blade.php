...
{{--                                </div>--}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12  visible-md visible-lg">
                                    ...
                                    <div class="col-md-1 font-bold" style="padding: 8px 15px; display: none;">
                                    ...
                                    <div class="col-md-2 font-bold" style="padding: 8px 15px; display: none;">
                                ...
                                <div class="col-xs-12 ">
                                    ...
                                    <div style="display:none;" class="row m-t-5" id="invoice-taxes">
                                        <div class="col-md-offset-9 col-md-1 text-right p-t-10">
