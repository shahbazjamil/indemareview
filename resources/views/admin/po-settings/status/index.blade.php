    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading p-t-10 p-b-10">Purchase Order Status</div>

                <div class="vtabs customvtab m-t-10">
                    @include('sections.po_setting_menu')

                    <div class="row">

                        <div class="col-md-12">
                            <div class="white-box p-0">
                                <h3>@lang('app.addNew') Status</h3>
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('.edit-type').click(function () {
        ...
        var url = '{{ route("admin.purchase-order-settings.edit", ":id")}}';
