    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading p-t-10 p-b-10">{{ __('Add Email Template') }}</div>
                                    ...
                                    <div class="row b-t m-t-20 p-10">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required name="template_name" class="form-control">
                                            </div>
                                            <hr>
                                            ...
                                            <div class="display-none email-file-div">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <div class="form-group">
                                                            <img src="{{ asset('img/img-dummy.jpg') }}" class="display-file-preview" alt="file" width="100" height="100">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
{{--                                            <div class="display:block">&lbrace;&lbrace;client.login_to_dashboard&rbrace;&rbrace;</div>--}}
                                            ...
                                            <div class="form-actions">
                                                <button type="button" onclick="submitForm();" class="btn btn-success"><i class="fa fa-check"></i>
                                                    Save
                                                </button>
                                            </div>
                                            {!! Form::close() !!}
