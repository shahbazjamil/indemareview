...
<div class="row">
    ...
    <div class="col-md-12 border-bottom m-b-10">
        <div class="user-btm-box">
            <div class="row row-in front-dashboard">
                <div class="col-md-3">
                    <h4 class="col-in row white-box">
                            <span class="counter">{{ $taskCompleted }}</span>
                            <span class="box-title">@lang('modules.employees.tasksDone')</span>
                            <div class="col-xs-4 d-none"><i class="ti-check-box text-success"></i></div>
                    </h4>
                </div>
                <div class="col-md-3">
                    <h4 class="col-in row white-box">
                        <span class="counter">{{ $hoursLogged }}</span>
                            <span class="box-title">@lang('modules.employees.hoursLogged')</span>
                        <div class="col-xs-2 d-none"><i class="icon-clock text-info"></i></div>
                    </h4>
                </div>
                <div class="col-md-3">
                    <h4 class="col-in row white-box">
                            <span class="counter">{{ $leavesCount }}</span>
                            <span class="box-title">@lang('modules.leaves.leavesTaken')</span>
                            <div class="col-xs-4 d-none"><i class="icon-logout text-warning"></i></div>
                    </h4>
                </div>
                <div class="col-md-3">
                    <h4 class="col-in row white-box">
                        <span class="counter">{{ ($allowedLeaves-count($leaves)) }}</span>
                            <span class="box-title">@lang('modules.leaves.remainingLeaves')</span>
                        <div class="col-xs-4 d-none"><i class="icon-logout text-danger"></i></div>
                    </h4>
                </div>
            </div>
        </div>
    ...
    <div class="col-xs-12">
        <div class="white-box p-0">
            <ul class="nav nav-tabs tabs customtab">
                <li class="active tab"><a href="#home" data-toggle="tab" class="btn-default"> <span class="visible-xs"><i class="fa fa-home"></i></span> <span class="hidden-xs">@lang('modules.employees.activity')</span> </a> </li>
                <li class="tab"><a href="#profile" data-toggle="tab" class="btn-default"> <span class="visible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">@lang('modules.employees.profile')</span> </a> </li>
                <li class="tab"><a href="#projects" data-toggle="tab" aria-expanded="true" class="btn-default"> <span class="visible-xs"><i class="icon-layers"></i></span> <span class="hidden-xs">@lang('app.menu.projects')</span> </a> </li>
                <li class="tab"><a href="#tasks" data-toggle="tab" aria-expanded="false" class="btn-default"> <span class="visible-xs"><i class="icon-list"></i></span> <span class="hidden-xs">@lang('app.menu.tasks')</span> </a> </li>
                <li class="tab"><a href="#leaves" data-toggle="tab" aria-expanded="false" class="btn-default"> <span class="visible-xs"><i class="icon-logout"></i></span> <span class="hidden-xs">@lang('app.menu.leaves')</span> </a> </li>
                <li class="tab"><a href="#time-logs" data-toggle="tab" aria-expanded="false" class="btn-default"> <span class="visible-xs"><i class="icon-clock"></i></span> <span class="hidden-xs">@lang('app.menu.timeLogs')</span> </a> </li>
                <li class="tab"><a href="#docs" data-toggle="tab" aria-expanded="false" class="btn-default"> <span class="visible-xs"><i class="icon-docs"></i></span> <span class="hidden-xs">@lang('app.menu.documents')</span> </a> </li>
            </ul>
