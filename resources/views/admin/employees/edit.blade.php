...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading p-b-10"> @lang('modules.employees.updateTitle')
                [ {{ $userDetail->name }} ]
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    @if($userDetail->email == $userDetail->company->company_email)
                                        <input type="email" readonly="" name="email" id="email" class="form-control" value="{{ $userDetail->email }}" autocomplete="nope">
                                    @else
