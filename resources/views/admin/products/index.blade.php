...
@push('head-script')
    ...
    <link rel="stylesheet" href="{{ asset('plugins/bower_components/bootstrap-datepicker/bootstrap-datepicker.min.css') }}">
			...
			div#view-details{max-height: 1200px; overflow-y: auto;}
				...
				.d-i-new .col-auto.status select{color:#D04E55;border:1px solid #f5c6cb !important;border-radius:7px}
                    ...
                    <div  class="row" id="ticket-filters">
                        ...
                        <form action="" id="filter-form">
                            ...
                            <div class="col-md-12">
                                <h5 >Project</h5>
                                <div class="form-group">
                                    <select name="fl_project_id" id="fl_project_id" class="form-control">
...
//        });
        ...
        $(document).on("click", ".pagination a", function() {
	        ...
	        // if(pag_block_id == 'paginationsAll'){
        	// 	var finalURL = url;		
        	// }else if(pag_block_id == 'paginationAll'){
        	// 	var finalURL = url;
        	// }else{
	        ...
	        $.get(finalURL, function(response) {
    		 	...
    		 	// if(pag_block_id == 'paginationsAll'){
    		 	// 	$('#products-wrp #view-details').html(response);
    		 	// }else if(pag_block_id == 'paginationAll'){
    				// $('#products-wrp #view-others').html(response); 		
    		 	// }else if(pag_block_id == 'pagination'){
    		 	// 	$('#products-wrp').html(response.view);
    		 	// 	// $('#products-wrp #view-others').html(response.view);	
    		 	// }else if(pag_block_id == 'paginations'){
    		 	// 	$('#products-wrp').html(response.view);
    		 	// 	// $('#products-wrp #view-details').html(response.view);
    		 	// }
        ...
        function loadTable (){
            ...
            var projectId = $('#fl_project_id').val();
            var salesCategory = $('#salesCategory').val();
            var locationCode = $('#locationCode').val();
