...
<!--                        @if($product->short_code != '' && !is_null($product->short_code))
                            <tr>
                                <td><b style="margin:0;">URL</b></td><td> <a href="{{route('shorten.link', $product->short_code)}}" >{{route('shorten.link', $product->short_code)}}</a></td>
                            </tr>
                        @endif-->
                        ...
                        @if($salesCategory != '' && !is_null($salesCategory))
                         ...
                         @if($product->quantity != '' && !is_null($product->quantity))
                            <tr>
                                <td><b style="margin:0;">QTY</b></td><td>{{ $product->quantity }}</td>
                            </tr>
                         @endif
