                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-6 b-t p-t-20">
                                            ...
                                            <div class="form-group">
                                                        <label class="control-label col-sm-8">When files added</label>

                                                        <div class="col-sm-4">
                                                            <div class="switchery-demo">
                                                                <input type="checkbox"
                                                                       @if($emailSettings[13]->send_email == 'yes') checked
                                                                       @endif class="js-switch change-email-setting"
                                                                       data-color="#99d683"
                                                                       data-setting-id="{{ $emailSettings[13]->id }}"/>
                                                            </div>
                                                        </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                        <label class="control-label col-sm-8">Estimate approved by client</label>

                                                        <div class="col-sm-4">
                                                            <div class="switchery-demo">
                                                                <input type="checkbox"
                                                                       @if($emailSettings[14]->send_email == 'yes') checked
                                                                       @endif class="js-switch change-email-setting"
                                                                       data-color="#99d683"
                                                                       data-setting-id="{{ $emailSettings[14]->id }}"/>
                                                            </div>
                                                        </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                        <label class="control-label col-sm-8">Invoice paid by client</label>

                                                        <div class="col-sm-4">
                                                            <div class="switchery-demo">
                                                                <input type="checkbox"
                                                                       @if($emailSettings[15]->send_email == 'yes') checked
                                                                       @endif class="js-switch change-email-setting"
                                                                       data-color="#99d683"
                                                                       data-setting-id="{{ $emailSettings[15]->id }}"/>
                                                            </div>
                                                        </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                        <label class="control-label col-sm-8">When contract is signed by client</label>

                                                        <div class="col-sm-4">
                                                            <div class="switchery-demo">
                                                                <input type="checkbox"
                                                                       @if($emailSettings[16]->send_email == 'yes') checked
                                                                       @endif class="js-switch change-email-setting"
                                                                       data-color="#99d683"
                                                                       data-setting-id="{{ $emailSettings[16]->id }}"/>
                                                            </div>
                                                        </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                        <label class="control-label col-sm-8">When discussion created on contract</label>

                                                        <div class="col-sm-4">
                                                            <div class="switchery-demo">
                                                                <input type="checkbox"
                                                                       @if($emailSettings[17]->send_email == 'yes') checked
                                                                       @endif class="js-switch change-email-setting"
                                                                       data-color="#99d683"
                                                                       data-setting-id="{{ $emailSettings[17]->id }}"/>
                                                            </div>
                                                        </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                        <label class="control-label col-sm-8">When note added to product review</label>

                                                        <div class="col-sm-4">
                                                            <div class="switchery-demo">
                                                                <input type="checkbox"
                                                                       @if($emailSettings[18]->send_email == 'yes') checked
                                                                       @endif class="js-switch change-email-setting"
                                                                       data-color="#99d683"
                                                                       data-setting-id="{{ $emailSettings[18]->id }}"/>
                                                            </div>
                                                        </div>
                                            </div>
