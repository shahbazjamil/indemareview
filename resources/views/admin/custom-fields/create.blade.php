...
<div class="modal-body">
    <div class="box-body">
        <div class="form-group">
            <label class="col-sm-2 control-label" for="display_name">Field Location</label>
            <div class="col-sm-10">
                {!! Form::select('module',
                    $customFieldGroups,
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="display_name">Field @lang('modules.invoices.type')</label>
<!--            'password'  => 'password',-->
<!--            'radio'    =>'radio',-->
            <div class="col-sm-10">
                {!! Form::select('type',
