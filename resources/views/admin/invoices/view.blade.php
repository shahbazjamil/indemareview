                            ...
                            <div class="pull-right text-right">
                                <address>
                                    ...
                                    @if($invoiceSetting->show_vat == 'yes' && !is_null($invoiceSetting->vat_number))
                                        <p class="text-muted m-l-5"><b>VAT Number
                                                :</b>{{ $invoiceSetting->vat_number }}</p>
                                    @endif
                            ...
                            <div class="table-responsive m-t-40" style="clear: both;">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right">@lang('modules.invoices.amount')</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php $count = 0; ?>
...
<!--                                                            <td class="text-center"><img src="{{ asset('img/default-product.png') }}" alt="product" width="75" height="75"></td>-->
                                                ...
                                                <td class="text-right">{!! currency_position($item->markup_fix, $invoice->currency->currency_symbol) !!}</td>
                                                <td class="text-right"> {!! currency_position($item->sale_price, $invoice->currency->currency_symbol) !!} </td>
                        ...
                        <div class="col-md-12">
                            <div class="pull-right m-t-30 text-right">
                                ...
                                @if ($invoice->amountRefund() > 0)
                                    <p>
                                        Refund: {{ currency_position($invoice->amountRefund(), $invoice->currency->currency_symbol) }}
                                    </p>
                                @endif
                            </div>
