                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                             <option @if($invoice->status == 'unpaid') selected @endif
...
{{--															</span>--}}
                                            ...
                                            <div class="col-md-1">
												<div class="hd">@lang('modules.invoices.tax') <a href="javascript:;" id="tax-settings" ><i class="ti-settings text-info"></i></a></div>
                                                <div class="form-group">
...
<script>
    ...
    $('#add-services').click(function () {
		 ...
		 + '<div class="hd">@lang('app.product.tabs.picture')</div>'
                + '<div class="form-group">'
                + '<label class="control-label hidden-md hidden-lg">@lang('app.product.tabs.picture')</label>'
                + '<p class="form-control-static 6"><img src="{{ asset('img/img-dummy.jpg') }}" alt="product" width="100" height="100"></p>'
                + '<input type="hidden" class="form-control" value="" name="product_id[]" >'
                + '<input type="hidden" class="form-control" value="" name="picture[]" >'
                + '</div>'
                + '</div>'
        ...
        $('#add-proposed').click(function () {
		 ...
		 + '<div class="hd">@lang('app.product.tabs.picture')</div>'
                + '<div class="form-group">'
                + '<label class="control-label hidden-md hidden-lg">@lang('app.product.tabs.picture')</label>'
                + '<p class="form-control-static 7"><img src="{{ asset('img/img-dummy.jpg') }}" alt="product" width="100" height="100"></p>'
                + '<input type="hidden" class="form-control" value="" name="product_id[]" >'
                + '<input type="hidden" class="form-control" value="" name="picture[]" >'
                + '</div>'
                + '</div>'
