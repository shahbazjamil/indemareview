@extends('layouts.app')
<style>
	#vendors-table_wrapper>.row:first-child{display:flex;flex-wrap:wrap;}
	#vendors-table_wrapper>.row div.col-md-6{width:auto !important;flex:0 0 auto;}
	.add-new-vendor-area{possition:relative;z-index:15;margin-bottom:-52px;border-top:1px solid rgb(227, 227, 227);}
</style>
@section('page-title')
<div class="row bg-title">
    ...
    <div @if($totalRecords == 0) style="display: none;"  @endif class="col-xs-6 p-t-10 p-b-10 add-new-vendor-area text-right pull-right">
        <a href="{{ route('admin.vendor.create') }}" class="btn btn-outline btn-success btn-sm">+ Add New Vendor</a>
        <div class="btn-group dropdown doverlay">
                ...
                <ul role="menu" class="dropdown-menu pull-right">
                    <li>
                        <a href="{{ route('admin.vendor.download-template') }}" target="_blank">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" name="email_form" action="{{ route('admin.vendor.sendEmail') }}"
...
<div @if($totalRecords > 0) style="display: none;"  @endif class="row flex-row flex-wrap nolist-content">
		...
		<div class="col-md-5">
			...
			<a href="{{ route('admin.vendor.create') }}" class="btn-black">+ Add New Vendor</a>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <form method='post' id="importCSVFrm" action='{{ route('admin.vendor.import') }}' enctype='multipart/form-data' >
                            {{ csrf_field() }}
                            <div class="form-body">
                                <div class="row ">
...
<script>
    $(".select2").select2({
        ...
        function exportData(){
            ...
            var url = '{{ route('admin.vendor.export', [':status', ':client']) }}';
        ...
        function sendEmail(email){
                //     var url = '{{ route('admin.vendor.showVendor', [':UrlId']) }}';
        ...
        $('body').on('click', '.vendor-detail', function () {
            ...
            var url = '{{ route('admin.vendor.showVendor', ":id")}}';
            url = url.replace(':id', id);
