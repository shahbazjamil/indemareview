    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading p-t-10 p-b-10">@lang('app.update') @lang('app.menu.projectSettings')</div>
                    ...
                    <div class="tab-content p-0 p-t-20">
                        <div id="vhome3" class="tab-pane active">
                            ...
                            <div class="row">
                                    <div class="col-sm-12 col-md-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label">Don’t sync products to QBO
                                            </label>
                                            <div class="switchery-demo">
                                                <input type="checkbox" id="sync_products_to_qb" name="sync_products_to_qb"
                                                       @if($productSetting->sync_products_to_qb == '0') checked
                                                       @endif class="js-switch " data-color="#00c292"
                                                       data-secondary-color="#f96262"/>
                                            </div>
                                        </div>
