        ...
        <div class="container">
            ...
            <div class="row" style="margin-top: 70px; !important;">
                ...
                <div class="col-md-12" id="estimates">
                    ...
                    <div class="card">
                        <div class="card-body front-dashboard">
                            <div class="white-box printableArea p-t-10 p-b-0">
                                <div class="sttabs tabs-style-line" id="invoice_container">
                                    <nav>
                                        <ul class="customtab" role="tablist" id="myTab">
                                            <li class="nav-item active"><a class="nav-link btn-default" href="#summery" data-toggle="tab" role="tab"><span><i class="glyphicon glyphicon-file"></i> @lang('modules.contracts.summery')</span></a>
                                            </li>

                                            <li class="nav-item"><a class="nav-link btn-default" href="#discussion" data-toggle="tab" role="tab"><span><i class="glyphicon glyphicon-comment"></i> @lang('modules.contracts.discussion')</span></a></li>
                                        </ul>
                                    </nav>
                                    ...
                                    <div class="tab-content tabcontent-border m-t-10">
                                        <div class="tab-pane active" id="summery" role="tabpanel">
                                            <div class="row p-0">
                                                <div class="col-md-8 contract-detail-wrp">
												<img src="{{ $global->logo_url }}" class="contact-view-img"/>
                                                    {!! $contract->contract_detail !!}
                                                </div>
                                                <div class="col-md-4 p-l-30 text-left">
                                                    <div class="card p-20">
                                                        <div class="card-body">
                                                            <address>
                                        ...
                                        <div class="tab-pane  p-20" id="discussion" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-8 w-n-l text-left">
