...
@section('content')
    ...
    <div class="row">
        <div class="panel panel-inverse">
            <div class="panel panel-inverse">
                <div class="panel-heading border-0"> @lang('app.add') @lang('app.menu.contract')</div>
            ...
            <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div>
                                <select class="select2 form-control" data-placeholder="@lang('app.contractTemplate')" id="template_id" name="template_id">
