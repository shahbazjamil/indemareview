...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="white-box p-0 front-dashboard m-b-10" id="attendanceData">
                <h4 class="dashboard-stats white-box"><span class="text-info-" id="totalDays"></span> <span class="font-12 text-muted m-l-5"> @lang('modules.attendance.totalWorkingDays')</span></h4>
