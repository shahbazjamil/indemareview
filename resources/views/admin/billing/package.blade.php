                ...
                <div class="table-responsive table-responsive-froid monthly-div">
					<table class="table table-hover table-bordered text-center">
						...
						<tbody>
							<tr>
								<td>
									<p class="m-t-25">For solo designers looking to manage all the essential aspects of their business in one place.</p>
								</td>
								<td>
									<p class="m-t-25">For medium-sized design firms looking to collaborate though a centralized system.</p>
								</td>
								<td>
									<p class="m-t-25">Bring your whole team together with all our features. Best for growing design firms.</p>
								</td>								
							</tr>
							<tr>
								<td>
									<h3 class="text-center">385/Yr  | 1 Free Month</h3>
								</td>
								<td>
									<h3 class="text-center">550/Yr | 2 Free Months</h3>
								</td>
								<td>
									<h3 class="text-center">675/Yr | 3 Free Months</h3>
								</td>								
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<i class="fa fa-check"></i> +$7/Mo for ea. additional user
								</td>								
							</tr>
							<tr>
								<td>
									<i class="fa fa-check"></i> All Core Features Included
								</td>
								<td>
									<i class="fa fa-check"></i>All Core Features Included
								</td>
							...
							<tr>
								<td>
									<i class="fa fa-check"></i> Fully Supported
								</td>
								<td>
									<i class="fa fa-check"></i> Fully Supported
								</td>
							...
							<tr>
								...
								<td>
									<i class="fa fa-check"></i> Designated Account Manager
								</td>								
							</tr>
							<tr>
