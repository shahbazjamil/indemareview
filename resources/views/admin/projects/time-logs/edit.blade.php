                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input style="width: 39%" type="number" name="total_hours" id="updatetotal_hours" value="{{ $timeLog->total_hours }}" class="form-control-sm">Hrs
                            <input style="width: 39%" type="number" name="total_minutes" id="updatetotal_minutes" value="{{ $timeLog->total_minutes }}" class="form-control-sm">Mins
    ...
    jQuery('#updateTime #start_date,#updateTime #end_date').datepicker({
      ...
      function calculateTime() {
        ...
        $.easyAjax({
            ...
            $('#updatetotal_hours').val(response.total_hours);
            $('#updatetotal_minutes').val(response.total_minutes);
...
//        } else {
//            //$('#updateTime #total_time').html(hours + "Hrs " + minutes + "Mins");
//            $('#updatetotal_hours').val(hours);
//            $('#updatetotal_minutes').val(minutes);
//        }
//
//    }
