                            ...
                            <div class="row">
                                <div class="col-md-12" id="task-list-panel">
                                    ...
                                    <div class="row m-b-10">
                                        <div class="col-md-12 hide" id="new-task-panel">
                                            <div class="panel panel-default">
                                                <div class="panel-heading p-t-10 p-b-10"><i class="ti-plus"></i> @lang('modules.tasks.newTask')
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea id="description_1" name="description"
                                    ...
                                    <div class="white-box p-0">
                                        <h2 class="border-bottom p-b-10">@lang('app.menu.tasks')</h2>
