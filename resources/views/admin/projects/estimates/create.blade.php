...
<!--    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>-->
    <h4 class="modal-title">@lang('modules.estimates.createEstimate')</h4>
<!--    - @lang('app.project') # {{ $project->id.' '.$project->project_name }}-->
</div>
<div class="modal-body">
    <div class="portlet-body">
        ...
        <div class="form-body">
            ...
            <?php if($project->clientdetails) { ?>
            
                {!! Form::hidden('client_id', $project->clientdetails->user_id) !!}
            ...
            <div class="form-body">
                            ...
                            <div class="col-md-3">
                                <div style="margin-bottom:0px !important; margin-top: 25px;" class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 border-bottom">
                                    ...
                                    <div class="col-md-offset-9 col-md-1 text-right p-t-5">
                                        Tax <a href="javascript:;" class="tax-settings-2"><i
                                            class="ti-settings text-info"></i></a>
                                    </div>
                                    <div class="form-group col-xs-6 col-md-2">
                                        <select id="multiTaxTotal" name="tax_on_total[]" multiple="multiple"
    ...
    <div class="modal-dialog modal-lg" id="modal-data-application">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn default close-md">@lang('app.close')</button>
...
<script>
    ...
    $(function () {
        ...
        $('#multiTaxTotal').selectpicker('refresh');
    ...
    $('.save-form').click(function(){
        ...
        $.easyAjax({
            ...
            type: "POST",
            redirect: true,
            data:$('#storePayments').serialize()+ "&cal_from=" + 'project',
