...
<script>
    ...
    $('.select-all-products').click(function () {
     ...
     $('body').on('click', '.p-image', function () {
            ...
            var url = "{{ route('admin.product-review-project.detail',[':id',':pid']) }}";
    ...
    function saveSettings(field_name){
        ...
        if($('#' + field_name).is(":checked")) {
         ...
         var projectID = '<?php echo $project->id; ?>';
         $.easyAjax({
            url: '{{route('admin.product-review-project.updateSetting', '1')}}',
            type: "POST",
    ...
    function updateStatus(productIDS, is_locked){
        ...
        $.easyAjax({
            url: '{{route('admin.product-review-project.update', '1')}}',
            type: "PUT",
    ...
    $('.create-finance').click(function () {
        ...
        $.easyAjax({
            url: '{{route('admin.product-review-project.create-finances')}}',
            type: "POST",
            redirect: true,
    ...
    $('body').on('click', '.view-product-notes', function () {
        ...
        var url = "{{ route('admin.product-review-project.view-product-notes',':id') }}";
     ...
     $('body').on('click', '.view-location-notes', function () {
        ...
        var url = "{{ route('admin.product-review-project.view-location-notes',':id') }}";
