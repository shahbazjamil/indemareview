    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading p-b-10 m-b-20"> @lang('modules.projects.createTitle')
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 deadlineBox">
                                    <div class="form-group">
                                        <label>@lang('modules.projects.deadlineTime')</label>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xs-12">
                                    <div class="form-group" >
                                        ...
                                        <select id="user_id" class="select2 m-b-10 select2-multiple " multiple="multiple"
                            ...
                            <h3 class="box-title m-b-10">@lang('modules.projects.clientInfo')
                                <a href="javascript:;" id="addClient" class="btn btn-sm btn-outline btn-success">+ @lang('app.add') Client </a></h3>
                            <div class="row">
                                <div class="col-md-4 ">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="max_weekly_hours" class="form-control">
                                    </div>
                                </div>
...
<script>
    ...
    $('#createProject').on('click', '#addClient', function () {
