                            ...
                            <div class="row">
                                <div class="col-md-12" id="issues-list-panel">
                                    <div class="white-box p-0">
                                        <h2 class="border-bottom p-b-10">@lang('app.menu.invoices')</h2>

                                        <div class="row m-b-10">
                                            <div class="col-md-12 border-bottom p-b-10">
                                                <a href="{{ route('admin.invoices.client', ['type' => 'timelog', 'sel_project_id' => $project->id]) }}"
            class="btn btn-outline btn-inverse btn-sm">+ @lang('app.create') @lang('app.timeLog') @lang('app.invoice') </a>
                                                <a href="javascript:;" id="show-invoice-modal" class="btn btn-outline btn-success btn-sm">+ @lang('modules.invoices.addInvoice')</a>
                                        ...
                                        <div style="display: none;" id="add-invoice-content"></div>

                                        <div class="table-responsive m-t-10" id="invoice-listing">
        ...
        $.easyAjax({
            ...
            success: function (response) {
                if (response.status == "success") {
                    $('#add-invoice-content').html(response.html);
                }
            }
        });
        $('#add-invoice-content').toggle();
         $('#invoice-listing').toggle();
...
//    })
    ...
    var table = $('#invoices-table').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{!! route('admin.invoices-project.data', $project->id) !!}',
        deferRender: true,
        language: {
