    ...
    <div class="row bg-title">
        ...
        <div class="col-sm-12 border-bottom p-t-10 p-b-10">
            <div class="form-group">
                <a href="{{ route('admin.add_file', ['folder_id'=>$folder_id]) }}" class="btn btn-info btn-sm">+ Add File</a>
            </div>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
...
@section('content')
    ...
    <div class="row dashboard-stats">
        <div class="col-md-12 m-t-20">
            <div class="white-box front-dashboard">
                <div class="col-md-12">
                    <h4 class="white-box"><span class="text-warning-" id="daysPresent">{{ sizeof($files) }}</span> <span class="font-12- text-muted-"> Files</span></h4>
                </div>
            </div>
        </div>
        <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td class=" text-center"><div class="btn-group dropdown m-r-10">
                                                ...
                                                <ul role="menu" class="dropdown-menu pull-right">
                                                    <li><a href="{{ route('admin.delete_file', ['folder_id'=>$folder_id, 'file_id'=>$folder->id]) }}"><i class="fa fa-times" aria-hidden="true"></i> Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
