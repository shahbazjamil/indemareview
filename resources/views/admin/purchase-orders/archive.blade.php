...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            <a href="{{ route('admin.purchase-orders.index') }}" class="btn btn-outline btn-success btn-sm">All Purchase Orders <i class="fa fa-search" aria-hidden="true"></i></a>
             <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="purchase-order-table">
                        <thead>
                        <tr>
                            <th>@lang('app.id')</th>
        ...
        $('body').on('click', '.revert', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('admin.purchase-orders.archive-restore',':id') }}";
                    url = url.replace(':id', id);
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function showData() {
        ...
        var url = "{{ route('admin.purchase-orders.archive-data',':id') }}";
