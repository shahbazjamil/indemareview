<div class="col-xs-12 item-row margin-top-5 d-flex-border">
    <div class="col-md-4">
        <div class="row">
            ...
            <div class="form-group">
                <textarea name="item_summary[]" class="form-control" placeholder="@lang('app.description')" rows="2">{{ $items->vendor_description }}</textarea>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="row">
            <div class="form-group">
                ...
                <input type="text" class="form-control cost_per_item" name="cost_per_item[]" data-item-id="{{ $items->id }}" value="{{ $items->cost_per_unit }}">
            </div>
        </div>
    </div>
