...
<div class="row bg-title">
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title"><i class="{{ $pageIcon }}"></i> Vendor </h4>
    </div>
    <!-- /.page title -->
    <!-- .breadcrumb -->
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading"> ADD VENDOR INFO</div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                    {!! Form::open(['id'=>'createClientVendor','class'=>'ajax-form','method'=>'POST']) !!}
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span class="help-block">Vendor will login using this email.</span>
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="mobile" id="mobile" value="{{ $leadDetail->mobile ?? '' }}"
                                        class="form-control">
                                </div>
                            </div>
                            <!--/span-->
                    ...
                    <div id="alertBox" style="display:none" class="alert alert-success" data-alert="alert">Data Succesfully Recorded.</div>
