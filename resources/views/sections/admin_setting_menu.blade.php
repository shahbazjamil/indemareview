...
<ul class="nav tabs-vertical">
    ...
    <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.currency.index') active @endif">
        <a href="{{ route('admin.currency.index') }}">@lang('app.menu.currencySettings')</a></li>
          ...
          <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.quickbooks.index') active @endif">
        <a href="{{ route('admin.integrations.index') }}">Integrations</a></li>
...
<!--        <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.ticket-agents.index') active @endif">
    ...
    @if(in_array('projects', $user->modules))
        <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.designations.index') active @endif">
            <a href="{{ route('admin.teams.index') }}">Team settings</a></li>
    @endif
    ...
    @if(in_array('messages',$user->modules))
        ...
        <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.product-settings.index') active @endif">
            <a href="{{ route('admin.product-settings.index') }}">@lang('app.menu.productSettings')</a></li>
    @endif
    
    <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.product-status.index') active @endif">
        <a href="{{ route('admin.product-status.index') }}">Product Statuses</a>
    </li>
    ...
    @if(in_array('purchaseOrders',$user->modules))
        <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.lead-source-settings.index') active @endif">
            <a href="{{ route('admin.purchase-order-settings.index') }}">Purchase Order Settings</a></li>
    @endif
    ...
    @if(in_array("tasks", $modules) )
<!--        <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.sales-category-settings.index') active @endif">
            <a href="{{ route('admin.sales-category-settings.index') }}">@lang('app.salesCategory') @lang('app.menu.settings')</a></li>-->
    @endif
...
<!--    @foreach ($worksuitePlugins as $item)
    ...
    <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.codeTypes.index') active @endif">
        <a href="{{ route('admin.codeTypes.index') }}">Location Codes</a>
    </li>
    <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.salescategoryTypes.index') active @endif">
        <a href="{{ route('admin.salescategoryTypes.index') }}">Sales Categories</a>
    </li>
    @if(Route::has('admin.zoom-setting.index'))
    <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.zoom-setting.index') active @endif">
        <a href="{{ route('admin.zoom-setting.index') }}">Zoom Setting</a>
    </li>
    @endif
    <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.email-template.index') active @endif">
        <a href="{{ route('admin.email-template.index') }}">@lang('app.menu.email_template')</a>
    </li>
    <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.email-connection-setting.index') active @endif">
        <a href="{{ route('admin.email-connection-setting.index') }}">@lang('app.menu.email_connection_setting')</a>
    </li>
