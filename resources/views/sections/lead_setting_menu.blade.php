...
<ul class="nav tabs-vertical">
    ...
    <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.lead-form-settings.index') active @endif">
        <a href="{{ route('admin.lead-form-settings.index') }}">@lang('app.menu.leadForm')</a></li>
</ul>
