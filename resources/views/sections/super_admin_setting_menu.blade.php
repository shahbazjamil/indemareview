...
<ul class="nav tabs-vertical">
    ...
    <!-- Bitsclam Code here -->
              <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'super-admin.quickbook.index') active @endif">
        <a href="{{ route('super-admin.quickbooks-settings.index') }}">@lang('app.menu.quickbooksSettings')</a></li>
