<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        @if(in_array('clients',$modules) || in_array('leads',$modules))
                ...
                <li><a href="{{ route('member.clients.index') }}" class="waves-effect"><i class="icon-people fa-fw"></i>
            ...
            @if($user->can('view_employees'))
                <li style="display: none;"><a href="{{ route('member.employees.index') }}" class="waves-effect"><i class="icon-user fa-fw"></i> <span class="hide-menu">@lang('app.menu.employees') </span></a> </li>
            @endif
            @endif
                ...
                <li><a href="{{ route('admin.task.index') }}" class="waves-effect"><i class="icon-layers fa-fw"></i>
                    ...
                    <ul class="nav nav-second-level collapse">
                        @if(in_array('projects',$modules))
                            <li><a href="{{ route('member.projects.index') }}"
                        ...
                        @if(in_array('tasks',$modules))
                            ...
                            <li class="hidden-sm hidden-xs"><a
                                        href="{{ route('member.taskboard.index') }}">@lang('modules.tasks.taskBoard')</a>
                            </li>
                            <li style="display: none;"><a href="{{ route('member.task-calendar.index') }}">@lang('app.menu.taskCalendar')</a>
                            </li>
                        @endif
                        @if(in_array('timelogs',$modules))
                            <li><a href="{{ route('member.all-time-logs.index') }}"
                                   class="waves-effect">@lang('app.menu.timeLogs')</a></li>
                        @endif
                        @if(in_array('projects',$modules))
                        <li><a href="{{ route('member.projects.free-flow-gantt') }}"
            ...
            @if(in_array('attendance',$modules))
                @if($user->can('view_attendance'))
                    <li style="display: none;"><a href="{{ route('member.attendances.summary') }}" class="waves-effect"><i class="icon-clock fa-fw"></i> <span class="hide-menu">@lang("app.menu.attendance") </span></a> </li>
                @else
                    <li style="display: none;"><a href="{{ route('member.attendances.index') }}" class="waves-effect"><i class="icon-clock fa-fw"></i> <span class="hide-menu">@lang("app.menu.attendance") </span></a> </li>
                @endif
            @endif
            ...
            @endif
            <li><a href="{{ route('member.view-file-manager') }}" class="waves-effect"><i class="icon-docs fa-fw"></i> <span
...
@if(in_array("purchaseOrders", $modules))
                        <li><a href="{{ route('member.purchase-orders.index') }}">Purchase Orders</a></li>
                       @endif
            ...
            <li><a href="{{ route('member.visionboard.index') }}" class="waves-effect"><i class="fa fa-bullseye fa-fw"></i> <span
            ...
            @if(in_array('events',$modules))
                ...
                <li><a href="{{ route('member.events.index') }}" class="waves-effect"><i
                                class="icon-calender fa-fw"></i> <span class="hide-menu">Calendar</span></a></li>
            @endif
...
<!--                <li><a href="{{ route('member.notices.index') }}" class="waves-effect"><i class="ti-layout-media-overlay fa-fw"></i> <span class="hide-menu">@lang("app.menu.noticeBoard") </span></a> </li>-->
            ...
            <li style="display: none;"><a href="{{ route('member.roadmap') }}" class="waves-effect"><i class="icon-book-open fa-fw"></i> <span class="hide-menu">Updates/Roadmap </span></a> </li>   
