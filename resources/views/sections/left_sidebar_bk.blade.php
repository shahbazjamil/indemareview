        ...
        <ul class="nav" id="side-menu">
            ...
            @if(in_array('clients',$modules) || in_array('leads',$modules))
                <li><a href="{{ route('admin.clients.index') }}" class="waves-effect"><i class="icon-people fa-fw"></i>
                        <span class="hide-menu"> @lang('app.menu.contacts') <span class="fa arrow"></span> </span></a>
                    <ul class="nav nav-second-level collapse">
                        @if(in_array('clients',$modules))
                            <li><a href="{{ route('admin.clients.index') }}"
                                   class="waves-effect">@lang('app.menu.clients')</a></li>
                        @endif
                        @if(in_array('leads',$modules))
                            <li><a href="{{ route('admin.leads.index') }}"
                                   class="waves-effect">@lang('app.menu.lead')</a>
                            </li>
                        @endif
                        @if(in_array('vendor',$modules))
                        <li><a href="{{ route('admin.vendor.index') }}"
                               class="waves-effect">Vendors</a>
                        </li>
                        @endif
                    </ul>
                </li>
...
<!--                            <li><a href="javascript:void(0)" class="waves-effect"><span
            ...
            @if(in_array("events", $modules))
                <li><a href="{{ route('admin.events.index') }}" class="waves-effect"><i class="icon-calender fa-fw"></i>
                        <span class="hide-menu">Schedules</span></a></li>
            @endif
...
<!--                <li><a href="{{ route('admin.notices.index') }}" class="waves-effect"><i
            ...
            <li><a target="_blank" href="https://indema.co/help" class="waves-effect"><i class="icon-docs fa-fw"></i> <span
                            class="hide-menu"> @lang('app.menu.faq')</span></a></li>
            <li><a href="{{ route('admin.roadmap') }}" class="waves-effect"><i class="icon-book-open fa-fw"></i> <span class="hide-menu">Indema Roadmap </span></a> </li>
            <li>
			<form>
