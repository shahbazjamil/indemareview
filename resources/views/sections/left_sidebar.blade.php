<div class="navbar-default sidebar" role="navigation">
                ...
                <div class="nav navbar-top-links navbar-right pull-right m-t-10">
                    <a class="btn btn-rounded btn-default timer-modal" href="javascript:;">@lang("modules.projects.activeTimers")
                        <span class="label label-danger"
                              id="activeCurrentTimerCount">@if($activeTimerCount > 0) {{ $activeTimerCount }} @else
                                0 @endif</span>
                    </a>
                </div>
            </span>
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="user-pro hidden-sm hidden-md hidden-lg">
                @if(is_null($user->image))
                    <a href="#" class="waves-effect"><img src="{{ asset('img/default-profile-3.png') }}" alt="user-img"
                                                          class="img-circle"> <span class="hide-menu">{{ (strlen($user->name) > 24) ? substr(ucwords($user->name), 0, 20).'..' : ucwords($user->name) }}
            ...
            <?php if (session()->get('super_admin_id')) { ?>
             <li><a href="{{ route('front.return-super-admin') }}" class="waves-effect"><i class="fa fa-sign-in"></i>
                    <span class="hide-menu">Return to Super Admin</span></a></li>
            <?php } ?>
            ...
            @if(in_array('clients',$modules) || in_array('leads',$modules) || in_array('vendor',$modules))
                <li><a href="{{ route('admin.clients.index') }}" class="waves-effect"><i class="icon-people fa-fw"></i>
                        <span class="hide-menu"> @lang('app.menu.contacts')</span></a>
                </li>
            @endif
            
            @if(in_array('projects',$modules))
            
            <li><a href="{{ route('admin.projects.index') }}" class="waves-effect"><i class="icon-layers fa-fw"></i>
                        <span class="hide-menu"> @lang('app.menu.projects')</span></a>
            </li>         
            @endif
            ...
            @if(in_array('contracts', $modules))
             ...
             <li><a href="{{ route('admin.contracts.index') }}" class="waves-effect"><i class="fa fa-file-text fa-fw"></i>
                        <span class="hide-menu"> @lang('app.menu.contracts')</span></a>
            </li>  
            ...
            @if(in_array('employees', $modules) || in_array('attendance', $modules) || in_array('holidays', $modules) || in_array('leaves', $modules))
                <li><a href="{{ route('admin.employees.index') }}" class="waves-effect"><i class="ti-user fa-fw"></i>
                        <span class="hide-menu"> Team <span class="fa arrow"></span> </span></a>
                    <ul class="nav nav-second-level collapse">
                        @if(in_array('employees',$modules))
                            <li><a href="{{ route('admin.employees.index') }}">Your Team</a></li>
                        ...
                        @if(in_array('leaves',$modules))
                            <li><a href="{{ route('admin.leaves.pending') }}"
                                   class="waves-effect">@lang('app.menu.leaves')</a></li>
                        @endif
                        @if(in_array('payroll',$modules))
{{--                        <li><a href="{{ route('admin.payroll.index') }}"--}}
{{--                                   class="waves-effect">PayRoll</a></li>--}}
                       @endif
                    </ul>
                </li>
            @endif
...
<li style="display: none;"><a href="{{ route('admin.task.index') }}" class="waves-effect"><i class="icon-layers fa-fw"></i>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        @if(in_array('tasks',$modules))
                            ...
                            <li style="display: none;"><a href="{{ route('admin.task-calendar.index') }}">@lang('app.menu.taskCalendar')</a>
                            </li>
                        @endif
                        ...
                        @endif
                        <li><a href="{{ route('admin.projects.free-flow-gantt') }}"
                                   class="waves-effect">Freeflow Gantt</a></li>

                    </ul>
                </li>
            @endif

            @if(Auth::user()->company->is_finance == 1)
                @if((in_array("estimates", $modules)  || in_array("invoices", $modules)  || in_array("payments", $modules) || in_array("expenses", $modules) || in_array("purchaseOrders", $modules)  ))
                    <li><a href="{{ route('admin.finance.index') }}" class="waves-effect"><i class="fa fa-money fa-fw"></i>
                            <span class="hide-menu"> @lang('app.menu.finance') @if($unreadExpenseCount > 0)
                                    <div class="notify notification-color"><span class="heartbit"></span><span
                                                class="point"></span></div>@endif <span class="fa arrow"></span> </span></a>
                        <ul class="nav nav-second-level collapse">
                           @if(in_array("estimates", $modules))
                            ...
                            <li><a href="{{ route('admin.client-invoice.index') }}">@lang('app.menu.invoices')</a></li>
    <!--                            <li><a href="javascript:void(0)" class="waves-effect"><span
                                                class="hide-menu"> @lang('app.menu.invoices')<span class="fa arrow"></span> </span></a>
                                    <ul class="nav nav-second-level">
                                        <li><a href="{{ route('admin.client-invoice.index') }}">Client</a></li>
                                        <li><a href="{{ route('admin.vendor-invoice') }}">Vendor</a></li>
                                    </ul>
                                </li>-->
                            @endif

                            @if(in_array("purchaseOrders", $modules))
                           ...
                           @endif
                            ...
                            {{-- Proposal Link Added Here --}}
                            @if(in_array('proposal', $modules))
                            <li>
                                <a href="{{ route('admin.proposal.index') }}" class="waves-effect">
            ...
            <li>
                <a href="{{ route('admin.events.index') }}" class="waves-effect"><i class="ti-briefcase fa-fw"></i>
                    <span class="hide-menu"> @lang('app.menu.business') <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level collapse">
                    @role('admin')
                    <li><a href="{{ route('admin.email-automation.index') }}" class="waves-effect"> <span
                                    class="hide-menu">Automation</span></a></li>
                                     @if(in_array("expenses", $modules))
                            <li>
                                <a href="{{ route('admin.expenses.index') }}">@lang('app.menu.expenses') @if($unreadExpenseCount > 0)
                                        <div class="notify notification-color"><span class="heartbit"></span><span
                                                    class="point"></span></div>@endif</a></li>
                        @endif
                    @endrole
                    @if(in_array("events", $modules))
                        <li><a href="{{ route('admin.events.index') }}" class="waves-effect">
                                <span class="hide-menu">Calendar</span></a></li>
                    @endif
                     @if(in_array('Zoom',$modules))
                    <li><a href="{{ route('admin.zoom-meeting.table-view') }}" class="waves-effect"> <span
                                    class="hide-menu"> Zoom Meeting</span></a></li>
                    @endif

                    <li><a href="{{ route('admin.view-file-manager') }}" class="waves-effect"> <span
                                    class="hide-menu">File Manager</span></a></li>
                                    <li><a href="{{ route('admin.projects.free-flow-gantt') }}"
                                   class="waves-effect">Freeflow Gantt</a></li>
                </ul>
            </li>
             ...
             @role('admin')
                    <li><a href="{{ route('admin.visionboard.index') }}" class="waves-effect"><i class="fa fa-bullseye fa-fw"></i> <span
                                    class="hide-menu"> @lang('app.menu.visionboard')</span></a> 
                    </li>
            @endrole
            ...
            @if(in_array("reports", $modules))
                <li><a href="{{ route('admin.reports.index') }}" class="waves-effect"><i class="ti-pie-chart fa-fw"></i>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        @if(in_array('timelogs',$modules))
                            <li><a href="{{ route('admin.time-log-report.index') }}">@lang('app.menu.timeLogReport')</a>
                            </li>
                        @endif

                        <li><a href="{{ route('admin.finance-report.index') }}">@lang('app.menu.financeReport')</a></li>
                        <li>
                            <a href="{{ route('admin.income-expense-report.index') }}">@lang('app.menu.incomeVsExpenseReport')</a>
                        </li>
                        <li><a href="{{ route('admin.leave-report.index') }}">@lang('app.menu.leaveReport')</a></li>
                        @if(in_array('attendance',$modules))
                            <li>
                                <a href="{{ route('admin.attendance-report.index') }}">@lang('app.menu.attendanceReport')</a>
                            </li>
                        @endif
                        {{--Aqeel code--}}
                        <li>
                            <a href="{{ route('admin.projectstatus.index') }}">Project Status Report</a>
                        </li>
                    </ul>
                </li>
            @endif
...
{{--            <li><a href="{{ route('admin.view-file-manager') }}" class="waves-effect"><i class="icon-docs fa-fw"></i> <span--}}
{{--                            class="hide-menu">File Manager</span></a></li>--}}


            @if(in_array("messages", $modules))
                <li><a href="{{ route('admin.user-chat.index') }}" class="waves-effect"><i
                                class="icon-envelope fa-fw"></i> <span
...
<!--                <li><a href="{{ route('admin.notices.index') }}" class="waves-effect"><i
                                class="ti-layout-media-overlay fa-fw"></i> <span
                                class="hide-menu">@lang('app.menu.noticeBoard') </span></a></li>-->
            @endif

            @role('admin')
                @if(Auth::user()->company->is_booking == 1)
                    <li><a href="{{ route('admin.bookings.index') }}" class="waves-effect"><i class="icon-book-open fa-fw"></i> <span
                                    class="hide-menu"> @lang('app.menu.bookings')</span></a> 
                    </li>
                @endif

                @if(Auth::user()->company->is_social == 1)
                <?php $auth_token = encode(Auth::user()->company->id, "social_token_sb"); ?>
                    <li><a href="https://social.indema.co/auth/signin?indema_token=<?= $auth_token ?>" target="_blank" class="waves-effect"><i class="icon-share fa-fw"></i> <span
                                    class="hide-menu"> Social </span></a>
                    </li>
                @endif
...
<!--            <li><a target="_blank" href="https://indema.co/gethelp" class="waves-effect"><i class="icon-docs fa-fw"></i> <span
                            class="hide-menu"> @lang('app.menu.faq')</span></a></li>-->
            <li style="display: none;"><a href="https://feedback.indema.co" target="_blank" class="waves-effect"><i class="icon-book-open fa-fw"></i> <span class="hide-menu">Indema Roadmap </span></a> </li>
            <li><a href="https://in.indema.co/" target="_blank" class="waves-effect"><i class="icon-book-open fa-fw"></i> <span class="hide-menu">Community</span></a> </li>
                            
                            
           <li>
			<form>
     <input onclick="toggle(this.form)" id="checkbox" name="checkbox" type="checkbox" /><label for="checkbox"><i class="ti-palette fa-fw"></i> Dark / Light</label>
    </form>
			</li>
           
            @if(in_array("tickets", $modules) && 1!=1)
                <li><a href="{{ route('admin.tickets.index') }}" class="waves-effect"><i class="ti-ticket fa-fw"></i>
                        <span class="hide-menu">@lang('app.menu.tickets')</span> @if($unreadTicketCount > 0)
                            <div class="notify notification-color"><span class="heartbit"></span><span
                                        class="point"></span></div>@endif</a></li>
            @endif
                        ...
                        @role('admin')
                            <li>
                                <a href="{{ route('admin.billing') }}">
                                    <i class="icon-book-open fa-fw"></i> @lang('app.menu.billing')
                                </a>
                            </li>
                        @endrole
                        <li>
                            <a href="{{ route('admin.settings.index') }}">
                                <i class="ti-settings fa-fw"></i>@lang('app.menu.settings')
                            </a>
                        </li>
                        <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                                document.getElementById('logout-form').submit();"
