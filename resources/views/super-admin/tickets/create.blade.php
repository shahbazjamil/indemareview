@extends('layouts.super-super-admin')
    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('super-admin.tickets.index') }}">{{ __($pageTitle) }}</a></li>
...
@section('other-section')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="control-label">@lang('modules.invoices.type') <a class="btn btn-xs btn-info btn-outline"
                                                                               href="javascript:;" id="add-type"><i
                                class="fa fa-plus"></i> @lang('modules.tickets.addType')</a></label>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label">@lang('modules.tickets.channelName') <a
                            class="btn btn-xs btn-info btn-outline" href="javascript:;" id="add-channel"><i
                            ...
                            <ul role="menu" class="dropdown-menu pull-right">
                                <li>
                                    <a href="javascript:;" class="submit-ticket"
                                       data-status="open">@lang('app.submit') @lang('app.open')
                                ...
                                <li>
                                    <a href="javascript:;" class="submit-ticket"
                                       data-status="pending">@lang('app.submit') @lang('app.pending')
                                        <span style="width: 15px; height: 15px;"
                                ...
                                <li>
                                    <a href="javascript:;" class="submit-ticket"
                                       data-status="resolved">@lang('app.submit') @lang('app.resolved')
                                        <span style="width: 15px; height: 15px;"
                                ...
                                <li>
                                    <a href="javascript:;" class="submit-ticket"
                                       data-status="closed">@lang('app.submit') @lang('app.close')
                                        <span style="width: 15px; height: 15px;"
...
@push('footer-script')
    ...
    <script>
        ...
        myDropzone = new Dropzone("div#file-upload-dropzone", {
            url: "{{ route('super-admin.ticket-files.store') }}",
        ...
        myDropzone.on('completemultiple', function () {
            ...
            window.location.href = '{{ route('super-admin.tickets.index') }}'
        ...
        $('.apply-template').click(function () {
            ...
            $.easyAjax({
                url: '{{route('super-admin.replyTemplates.fetchTemplate')}}',
                type: "POST",
        ...
        $('.submit-ticket').click(function () {
            ...
            $.easyAjax({
                url: '{{route('super-admin.tickets.store')}}',
        ...
        $('#add-type').click(function () {
            var url = '{{ route("super-admin.ticketTypes.createModal")}}';
            $('#modelHeading').html("{{ __('app.addNew').' '.__('modules.tickets.ticketTypes') }}");
            $.ajaxModal('#ticketModal', url);
        })

        $('#add-channel').click(function () {
            var url = '{{ route("super-admin.ticketChannels.createModal")}}';
            $('#modelHeading').html("{{ __('app.addNew').' '.__('modules.tickets.ticketTypes') }}");
            $.ajaxModal('#ticketModal', url);
        })
