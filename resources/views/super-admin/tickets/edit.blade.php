                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-md-12 m-b-10">
                            ...
                            <div class="font-12">
                                {{ $ticket->created_at->timezone($global->timezone)->format($global->date_format.' '.$global->time_format) }} &bull; {{ ucwords($ticket->requester->name). ' <'.$ticket->requester->email.'>' }}</div>
                        </div>
                                    ...
                                    <ul role="menu" class="dropdown-menu pull-right">
                                        <li>
                                            <a href="javascript:;" class="submit-ticket"
                                               data-status="open">@lang('app.submit')
                                                as Open
...
@push('footer-script')
    ...
    <script>
        ...
        $('.submit-ticket').click(function () {
            ...
            $.easyAjax({
                url: '{{route('super-admin.tickets.update', $ticket->id)}}',
        ...
        $('.submit-ticket-2').click(function () {
            ...
            $.easyAjax({
                url: '{{route('super-admin.tickets.updateOtherData', $ticket->id)}}',
