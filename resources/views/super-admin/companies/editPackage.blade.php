                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="licence_expires_on" id="licence_expires_on" class="form-control" value="{{ $company->licence_expire_on ? $company->licence_expire_on->format('m/d/Y') : ''}}" >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
