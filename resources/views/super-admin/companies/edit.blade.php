                        ...
                        <div class="form-body">
                            ...
                            @if(($companyUser))
                                ...
                                <hr>
                                 ...
                                 @if($companyUser->email_verification_code != null)
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Verification</label>
                                                <select name="email_verification_code" id="email_verification_code" class="form-control">
                                                    <option value="verified" @if($companyUser->email_verification_code == null) selected @endif>Verified</option>
                                                    <option value="not_verified" @if($companyUser->email_verification_code != null) selected @endif>Not Verified</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
