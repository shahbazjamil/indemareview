                        ...
                        <table class="inner-body mail-body-table" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-cell mail-body-table-td">
                                    ...
                                    <p>
                                        This is a friendly reminder that you have an automation step inside <b>{{ $name }}</b> that needs to be sent manually. Please login to send this email out to your client.
                                    </p>
                                </td>
                            </tr>
                        </table>
