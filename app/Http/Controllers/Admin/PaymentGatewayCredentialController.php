...
class PaymentGatewayCredentialController extends AdminBaseController
{
    ...
    public function update(UpdateGatewayCredentials $request, $id)
    {
        ...
        $credential->plaid_client_id = $request->plaid_client_id;
        $credential->plaid_secret = $request->plaid_secret;
        ($request->plaid_status) ? $credential->plaid_status = 'active' : $credential->plaid_status = 'deactive';
