...
class ManageProjectVisionboardsController extends AdminBaseController
{
    ...
    public function show($id)
    {
        ...
        return view('admin.projects.visionboard.show', $this->data);
    }
    ...
    {
        $milestones = ProjectMilestone::with('currency')->where('project_id', $id)->orderBy('id', 'desc')->get();
