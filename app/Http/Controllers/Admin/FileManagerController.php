...
class FileManagerController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $this->mixPanelTrackEvent('view_page', array('page_path' => '/admin/show-file-manager'));
...
//    }
    ...
    public function create_folder()
    {
        ...
        return redirect()->route('admin.view-file-manager');
    }
...
//        $all_files = File::allFiles($path);
        ...
        return view('admin.file-manager.folder',$this->data);
    }
    ...
    public function add_file($folder_id)
    {
        ...
        return view('admin.file-manager.add_file',$this->data);
    }
    ...
    public function delete_file($folder_id, $file_id)
    {
        ...
        return redirect()->route('admin.preview_folder', ['folder_id'=>$folder_id]);
    }
    ...
    public function checkPassword(Request $request)
    {
        if(isset($request->folder_id) && !is_null($request->folder_id) &&  isset($request->folder_password) && !is_null($request->folder_password)) {
            ...
            if($folder && $folder->folder_password == $folder_password) {
                ...
                return Reply::redirect(route('admin.preview_folder', ['folder_id'=>$folder->id], 'The password matched.'));
            }
        }
