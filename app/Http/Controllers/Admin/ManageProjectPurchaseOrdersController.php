...
class ManageProjectPurchaseOrdersController extends AdminBaseController
{
...
//    }
    ...
    public function show($id)
    {
        ...
        return view('admin.projects.purchase-order.show', $this->data);
    }
            ...
            ->addColumn('action', function ($row) {
              $action = '<div class="btn-group dropdown m-r-10">
                ...
                <ul role="menu" class="dropdown-menu pull-right">
                  <li><a href="' . route('admin.purchase-orders.edit', $row->id) . '"><i class="fa fa-pencil" aria-hidden="true"></i> ' . trans('app.edit') . '</a></li>';
                ...
                $action .= '<li><a href="' . route("admin.purchase-orders.download", $row->id) . '"><i class="fa fa-download"></i> ' . __('app.download') . '</a></li>';
...
//                }
           ...
           ->editColumn(
                ...
                function ($row) {
                    ...
                    return $row->purchase_order_date->format($this->global->date_format);
                }
            )
           ->editColumn(
                'status',
