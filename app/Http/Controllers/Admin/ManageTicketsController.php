...
class ManageTicketsController extends AdminBaseController
{
    ...
    public function store(StoreTicket $request)
    {
        ...
        $objDemo->Message = $request->description;
        $objDemo->Subject = 'New Support Ticket Requested ['.$ticket->subject.'] - '.$ticket->requester->company->company_name;
        $objDemo->FromEmail = $ticket->requester->email;
        $objDemo->FromName = $ticket->requester->name;
        
        Mail::to('support@indema.co')->send(new SupportEmail($objDemo));
        // END
...
//        echo $this->ticket;
    ...
    {
        return view('admin.tickets.roadmap', $this->data);
    }
}
