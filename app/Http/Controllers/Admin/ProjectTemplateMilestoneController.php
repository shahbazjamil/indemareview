...
class ProjectTemplateMilestoneController extends AdminBaseController
{
    ...
    public function show($id)
    {
        ...
        return view('admin.project-template.milestone.show', $this->data);
    }
    ...
    public function milestoneDetail($id)
    {
        ...
        return view('admin.project-template.milestone.milestone-detail', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->currencies = Currency::all();
        $view = view('admin.project-template.milestone.edit', $this->data)->render();
