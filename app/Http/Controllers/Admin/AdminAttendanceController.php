...
class AdminAttendanceController extends AdminBaseController
{
    ...
    {
        $this->mixPanelTrackEvent('view_page', array('page_path' => '/admin/attendances/summary'));
        ...
        return view('admin.clockin-out.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.clockin-out.create', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->type = 'edit';
        return view('admin.clockin-out.attendance_mark', $this->data);
    }
    ...
    public function employeeData($startDate = null, $endDate = null, $userId = null)
    {
        ...
        // Getting View data
        $view = view('admin.clockin-out.user_attendance', ['dateWiseData' => $dateWiseData, 'global' => $this->global])->render();
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($attendances)
            ->editColumn('id', function ($row) {
                return view('admin.clockin-out.attendance_list', ['row' => $row, 'global' => $this->global, 'maxAttandenceInDay' => $this->maxAttandenceInDay])->render();
            })
            ->rawColumns(['id'])
            ->removeColumn('name')
