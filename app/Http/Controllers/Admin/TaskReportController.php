...
class TaskReportController extends AdminBaseController
{
    ...
    {
        $this->mixPanelTrackEvent('view_page', array('page_path' => '/admin/reports/task-report'));
    ...
    //  not working , need to fix
     ...
     public function show(Request $request) {
        ...
        $exportArray[] = ['Project Name', 'Title', 'Column Name', 'Due Date'];
        ...
        foreach ($tasks as $row) {
            ...
            if (is_null($row->project_id)) {
                $rowArrayData['project_name'] = '';
            } else {
                $rowArrayData['project_name'] =  ucfirst($row->project_name);
            }
            $rowArrayData['heading'] = $row->heading;
            $rowArrayData['column_name'] = $row->column_name;
            $rowArrayData['due_date'] = $row->due_date->format($this->global->date_format);
