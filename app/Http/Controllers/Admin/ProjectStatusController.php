...
use App\DataTables\Admin\ProjectStatusReportDataTable;
use App\Project;
use Illuminate\Http\Request;

class ProjectStatusController extends AdminBaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->pageTitle = 'Project Status Report';
    ...
    public function index(ProjectStatusReportDataTable $dataTable)
    {
        $this->mixPanelTrackEvent('view_page', array('page_path' => '/admin/reports/projectstatus'));

        $this->projects = Project::all()->where('company_id', auth()->user()->company_id);
//        echo $this->projects;
//        echo $this->data;
        return $dataTable->render('admin.reports.projectstatus.index', $this->data);
    }
    ...
    public function report(Request $request)
    {
        ...
        $this->totalProjects = Project::all();


        return Reply::dataOnly(['status' => 'success', 'data' => $this->totalProjects]);
    }
