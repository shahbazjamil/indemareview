...
class ManageAllCreditNotesController extends AdminBaseController
{
    ...
    public function index(AllCreditNotesDataTable $dataTable)
    {
        ...
        $this->mixPanelTrackEvent('view_page', array('page_path' => '/admin/all-credit-notes'));
...
//        $creditNote->status = $request->status;
    ...
    public function projectNotesShow(AllCreditNotesDataTable $dataTable , $id)
    {
        $this->project = Project::findOrFail($id);
        return $dataTable->with('projectID', $id)->render('admin.projects.credit-notes.show', $this->data);
