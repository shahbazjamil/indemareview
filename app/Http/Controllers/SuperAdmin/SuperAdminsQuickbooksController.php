...
class SuperAdminsQuickbooksController extends SuperAdminBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return Reply::redirect(route('super-admin.quickbooks-settings.index'), __('messages.quickbooksCreated'));
    }
    ...
    {   
        ...
        return Reply::redirect(route('super-admin.quickbooks-settings.index'), __('messages.quickbooksUpdated'));
    }
