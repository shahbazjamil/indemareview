...
class ClientDiscussionReplyController extends ClientBaseController
{
    ...
    public function create()
    {
        ...
        return view('client.discussion-reply.create', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('client.discussion-reply.edit', $this->data);
    }
    ...
    public function ajaxDiscussionReplies($discussionId)
    {
        ...
        $html = view('client.discussion-reply.reply', $this->data)->render();
