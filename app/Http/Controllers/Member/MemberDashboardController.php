...
class MemberDashboardController extends MemberBaseController
{
    ...
    {
        $this->mixPanelTrackEvent('view_page', array('page_path' => '/member/dashboard'));
        ...
        if(isset($_REQUEST['is_debug']) && $_REQUEST['is_debug'] == 1) {
           
           
            var_dump($this->user->can('add_invoices'));exit;
        }
