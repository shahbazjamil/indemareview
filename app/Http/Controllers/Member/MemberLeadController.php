...
class MemberLeadController extends MemberBaseController
{
    ...
    {
        $this->mixPanelTrackEvent('view_page', array('page_path' => '/member/leads'));
    ...
    {
        $this->mixPanelTrackEvent('view_page', array('page_path' => '/member/leads/archive'));


        return view('member.lead.archive', $this->data);
    }
    ...
    public function data(CommonRequest $request, $id = null)
    {
        ...
        $lead = $lead->where('client_id', '=', '')->orWhereNull('client_id');
    ...
    public function archiveData(CommonRequest $request, $id = null)
    {
        $currentDate = Carbon::today()->format('Y-m-d');
        $lead = Lead::select(
            'leads.id',
    ...
    public function store(StoreRequest $request)
    {
        ...
        $this->mixPanelTrackEvent('lead_created', array('page_path' => '/member/leads'));
