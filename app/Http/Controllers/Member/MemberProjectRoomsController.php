...
class MemberProjectRoomsController extends MemberBaseController
{
...
//        });
    ...
    public function show($id)
    {
        ...
        return view('member.projects.rooms.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('member.projects.rooms.edit', $this->data);
    }
...
//        $teetime->destroy();
    ...
    public function detail($id)
    {
        $this->room = ProjectRoom::findOrFail($id);
         $this->room_products = ProjectRoomProduct::where('room_id', $id)->get();
        return view('member.projects.rooms.detail', $this->data);
    }
