        ...
        return datatables()
            ...
            ->editColumn('users', function ($row) {
                ...
                foreach ($row->users as $member) {
                    ...
                    alt="user" class="img-circle" width="25" height="25"> ' : $nameletter . '"
                    alt="user" class="img-circle" width="25" height="25"> ';
                    } else {
                        $members .= '<span data-toggle="tooltip" data-original-title="' . ucwords($member->user->name) . '" class="nameletter">'.company_initials().'</span>';
                    }
