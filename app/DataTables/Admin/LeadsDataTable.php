    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->editColumn('client_name', function ($row) {
                ...
                return  '<div class="row truncate"><div class="col-sm-3 col-xs-4">' . $nameletter . '</div><div class="col-sm-9 col-xs-8"><a href="' . route('admin.leads.show', $row->id) . '">' . ucwords($row->client_name) . '</a><br><span class="text-muted font-12">' . $label . '</span></div></div>';
