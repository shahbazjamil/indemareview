...
//            })
            ...
            ->editColumn('client.name', function ($row) {
                ...
                $cName = '--';
                if(isset($row->client) && $row->client->image) {
                    $cName = ucwords($row->client->name);
                ...
                return  '<div class="row truncate"><div class="col-sm-3 col-xs-4">' . $image . '</div><div class="col-sm-9 col-xs-8"><a href="' . route('admin.clients.show', $row->client_id) . '">' . $cName . '</a></div></div>';
