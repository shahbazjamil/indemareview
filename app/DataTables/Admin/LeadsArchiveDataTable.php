...
class LeadsArchiveDataTable extends BaseDataTable
{
    /**
...
//            })
            ...
            ->editColumn('client_name', function ($row) {
                ...
                //' . route('admin.leads.show', $row->id) . '
                $nameletter = '<span class="nameletter">'.company_initials().'</span>';
                return  '<div class="row truncate"><div class="col-sm-3 col-xs-4">' . $nameletter . '</div><div class="col-sm-9 col-xs-8"><a href="javascript:void(0)">' . ucwords($row->client_name) . '</a><br><span class="text-muted font-12">' . $label . '</span></div></div>';
            ...
            ->addIndexColumn()
            ->rawColumns(['status', 'client_name', 'next_follow_up_date']);
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            'Lead Name' => ['data' => 'client_name', 'name' => 'client_name'],
