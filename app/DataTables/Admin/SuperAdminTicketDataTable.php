...
class SuperAdminTicketDataTable extends BaseDataTable
{
    /**
        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                <ul role="menu" class="dropdown-menu">
                  <li><a href="' . route("super-admin.tickets.edit", $row->id) . '" ><i class="fa fa-eye"></i> ' . __('app.view') . '</a></li>
            ...
            ->editColumn('created_at', function ($row) {
                return $row->created_at->timezone($this->timezone)->format($this->date_format . ' ' . $this->time_format);
            })
    ...
    public function query(Ticket $model)
    {
        ...
        $model = $model->select('tickets.*')->withoutGlobalScope(CompanyScope::class);
