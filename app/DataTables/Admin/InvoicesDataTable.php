...
//                }
    ...
    public function query(Invoice $model)
    {
        ...
        }, 'currency:id,currency_symbol,currency_code', 'project.client','vendor','client'])
            ->select('invoices.id', 'invoices.project_id', 'invoices.client_id', 'invoices.invoice_number', 'invoices.currency_id', 'invoices.total', 'invoices.deposit_req', 'invoices.status', 'invoices.issue_date', 'invoices.credit_note', 'invoices.show_shipping_address', 'invoices.send_status','invoices.vendor_id', 'invoices.refund_status', 'invoices.tags');
        ...
        $model = $model->orderBy('invoices.id', 'desc');
        return $model;
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            //__('app.vendor') => ['data' => 'vendor_name'],
