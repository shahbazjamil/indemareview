...
class MemberProductsDataTable extends BaseDataTable
{
    /**
            ...
            ->addColumn('action', function ($row) {
                ...
                <ul role="menu" class="dropdown-menu pull-right">
                  <li><a href="' . route('member.products.edit', [$row->id]). '"><i class="fa fa-pencil" aria-hidden="true"></i> ' . trans('app.edit') . '</a></li>
                    <li><a href="' . route('member.products.edit', [$row->id, "copy"=>1]). '"><i class="fa fa-copy" aria-hidden="true"></i> ' . trans('app.copy') . '</a></li>
