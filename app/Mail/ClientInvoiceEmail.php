...
//        $name = 'WorkSuite Payroll Systems';
        ...
        if($this->data->pdf){
            ...
            return $this->view('admin.vendor.email')
                    ...
                    ->with(['bodyMessage' => htmlspecialchars($this->data->Message), 'invoiceID' => isset($this->data->invoiceID) ? $this->data->invoiceID : '' , 'estimateID' => isset($this->data->estimateID) ? $this->data->estimateID : '']);
        } else {
