...
class Contract extends BaseModel
{
    ...
    {
        return $this->belongsTo(User::class, 'user_id')->withoutGlobalScope(CompanyScope::class);
    }
    ...
    public function client_signature()
    {
        return $this->hasOne(ClientContractSign::class, 'contract_id');
    }
